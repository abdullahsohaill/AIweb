...
**Page Title:** Qwen/Qwen2.5-VL-72B-Instruct · Hugging Face
--------------------
...
## Model tree for Qwen/Qwen2.5-VL-72B-Instruct

## Spaces using Qwen/Qwen2.5-VL-72B-Instruct 100

## Collection including Qwen/Qwen2.5-VL-72B-Instruct

## Papers for Qwen/Qwen2.5-VL-72B-Instruct
...
Qwen/Qwen2.5-VL-72B-Instruct is supported by the following Inference Providers:
