...
# --- CONFIGURATION ---
# Adjust this path to where your master file actually is relative to this script
INPUT_MASTER_FILE = "../services_collection/final_tools_1M_vetting/final_tools_1M_reduced.csv"
...
def main():
    ...
    if len(df) < SAMPLE_SIZE:
        print("   ⚠️ Dataset smaller than sample size. Taking all.")
        sample_df = df
    else:
