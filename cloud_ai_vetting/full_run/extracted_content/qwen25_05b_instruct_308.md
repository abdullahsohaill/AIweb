...
**Page Title:** Qwen/Qwen2.5-0.5B-Instruct · Hugging Face
--------------------
...
## Model tree for Qwen/Qwen2.5-0.5B-Instruct

Base model

## Spaces using Qwen/Qwen2.5-0.5B-Instruct 100

## Collection including Qwen/Qwen2.5-0.5B-Instruct

## Paper for Qwen/Qwen2.5-0.5B-Instruct
