...
**Page Title:** meta-llama/Llama-4-Scout-17B-16E-Instruct · Hugging Face
--------------------
...
[LINK: https://github.com/meta-llama/llama-models/blob/main/models/llama4/LICENSE](https://github.com/meta-llama/llama-models/blob/main/models/llama4/LICENSE)
...
[LINK: here](https://github.com/meta-llama/llama-cookbook)
...
[LINK: Developer Use Guide: AI Protections](https://ai.meta.com/static-resource/developer-use-guide-ai-protections)
...
Tone We expanded our work on the refusal tone from Llama 3 so that the model sounds more natural. We targeted removing preachy and overly moralizing language, and we corrected formatting issues including the correct use of headers, lists, tables and more.
...
[LINK: reference implementation](https://github.com/meta-llama/llama-agentic-system)
...
## Model tree for meta-llama/Llama-4-Scout-17B-16E-Instruct

Base model

## Spaces using meta-llama/Llama-4-Scout-17B-16E-Instruct 100

## Collection including meta-llama/Llama-4-Scout-17B-16E-Instruct

## Paper for meta-llama/Llama-4-Scout-17B-16E-Instruct
