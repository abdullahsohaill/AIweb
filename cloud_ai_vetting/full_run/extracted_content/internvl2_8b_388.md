...
**Page Title:** OpenGVLab/InternVL2-8B · Hugging Face
--------------------
...
InternVL 2.0 is a multimodal large language model series, featuring models of various sizes. For each size, we release instruction-tuned models optimized for multimodal tasks. InternVL2-8B consists of InternViT-300M-448px , an MLP projector, and internlm2_5-7b-chat .
...
## Model tree for OpenGVLab/InternVL2-8B

## Spaces using OpenGVLab/InternVL2-8B 6

## Collection including OpenGVLab/InternVL2-8B

## Papers for OpenGVLab/InternVL2-8B
