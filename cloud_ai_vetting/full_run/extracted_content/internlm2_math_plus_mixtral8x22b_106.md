...
**URL:** https://huggingface.co/internlm/internlm2-math-plus-mixtral8x22b
**Page Title:** internlm/internlm2-math-plus-mixtral8x22b · Hugging Face
--------------------
...
💻 Github 🤗 Demo
[LINK: 💻 Github](https://github.com/InternLM/InternLM-Math)
...
[LINK: MathBench-A](https://github.com/open-compass/MathBench)

## Citation and Tech Report

## Model tree for internlm/internlm2-math-plus-mixtral8x22b

## Space using internlm/internlm2-math-plus-mixtral8x22b 1

## Collection including internlm/internlm2-math-plus-mixtral8x22b

## Paper for internlm/internlm2-math-plus-mixtral8x22b
