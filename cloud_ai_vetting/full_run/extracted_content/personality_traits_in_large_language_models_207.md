...
**Page Title:** Paper page - Meta-training with Demonstration Retrieval for Efficient Few-shot Learning
--------------------
...
Meta-training with demonstration retrieval enhances few-shot NLP performance by leveraging dense passage retrievers and external knowledge sources.
...
variety of tasks. To overcome this issue, we propose meta-training with demonstration retrieval , where we use a dense passage retriever to retrieve
semantically similar labeled demonstrations to each example for more varied
supervision. By separating external knowledge from model parameters, we can use meta-training to train parameter-efficient models that generalize well on a
larger variety of tasks. We construct a meta-training set from UnifiedQA and CrossFit , and propose a demonstration bank based on UnifiedQA tasks. To our
...
targeted parameter-efficient and retrieval-augmented few-shot methods on QA , NLI , and text classification tasks (including SQuAD , QNLI , and TREC ). Our
