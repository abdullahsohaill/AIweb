...
**Page Title:** Mistral Small 3.1 24B (free) - API, Providers, Stats | OpenRouter
--------------------
...
## Providers for Mistral Small 3.1 24B (free)

### OpenRouter routes requests to the best providers that are able to handle your prompt size and parameters, with fallbacks to maximize uptime .

[LINK: routes requests](/docs/provider-routing)

## Performance for Mistral Small 3.1 24B (free)
...
## Apps using Mistral Small 3.1 24B (free)

### Top public apps this month

[LINK: Domain Classifier Test](/apps?url=https%3A%2F%2Fgithub.com%2Fdomain-classifier)

## Recent activity on Mistral Small 3.1 24B (free)

### Total usage per day on OpenRouter

Prompt tokens measure input size. Reasoning tokens show internal thinking before a response. Completion tokens reflect total output length.

## Uptime stats for Mistral Small 3.1 24B (free)

### Uptime stats for Mistral Small 3.1 24B (free) on the only provider
...
## Sample code and API for Mistral Small 3.1 24B (free)
