...
**Page Title:** facebook/wav2vec2-large-xlsr-53 · Hugging Face
--------------------
...
[LINK: https://github.com/pytorch/fairseq/tree/master/examples/wav2vec#wav2vec-20](https://github.com/pytorch/fairseq/tree/master/examples/wav2vec#wav2vec-20)

## Usage

See this notebook for more information on how to fine-tune the model.
[LINK: this notebook](https://colab.research.google.com/github/patrickvonplaten/notebooks/blob/master/Fine_Tune_XLSR_Wav2Vec2_on_Turkish_ASR_with_%F0%9F%A4%97_Transformers.ipynb)
[LINK: NEW](https://huggingface.co/docs/inference-providers)

## Model tree for facebook/wav2vec2-large-xlsr-53

## Dataset used to train facebook/wav2vec2-large-xlsr-53

## Spaces using facebook/wav2vec2-large-xlsr-53 31

## Collection including facebook/wav2vec2-large-xlsr-53

## Paper for facebook/wav2vec2-large-xlsr-53
