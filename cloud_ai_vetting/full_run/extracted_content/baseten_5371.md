...
**Page Title:** Inference Platform: Deploy AI models in production | Baseten
--------------------
...
[LINK: Learn more](/products/model-apis/)
- DeepSeek V3.2 Try It
DeepSeek V3.2
- GPT OSS 120B Try It
GPT OSS 120B
- Kimi K2 Thinking Try It
Kimi K2 Thinking
- Explore the model Library Explore
...
[LINK: docs](https://docs.baseten.co/development/model/build-your-first-model)
