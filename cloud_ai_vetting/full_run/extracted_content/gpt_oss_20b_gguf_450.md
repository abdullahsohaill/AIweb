...
**Page Title:** unsloth/gpt-oss-20b-GGUF · Hugging Face
--------------------


## Read our How to Run gpt-oss Guide here!

[LINK: Run gpt-oss Guide here!](https://docs.unsloth.ai/models/gpt-oss-how-to-run-and-fine-tune)
...
[LINK: Google Colab notebook](https://colab.research.google.com/github/unslothai/notebooks/blob/main/nb/gpt-oss-(20B)-Fine-tuning.ipynb)
...
## Model tree for unsloth/gpt-oss-20b-GGUF

Base model

## Spaces using unsloth/gpt-oss-20b-GGUF 8

## Collections including unsloth/gpt-oss-20b-GGUF
