# HARPA AI
**URL:** https://harpa.ai
**Page Title:** HARPA AI Browser Agent | ChatGPT, Claude, Gemini, Perplexity
--------------------


## AI AGENT FOR WEB BROWSING

## Summarize YouTube videos, blogs, PDFs in seconds, answer emails, proofread, generate articles, extract data and automate your work with contextual & practical AI.
...
HARPA AI is a browser extension, powered by hybrid AI-engine that combines ChatGPT, Gemini, ClaudeAI, Perplexity, DeepSeek with Web Automation. Read the Get Started Guide to find out more.
...
Basic S plan starts with $12 per month paid annually, includes CloudGPT connection, cloud command storage, chat history and more .
...
HARPA CloudGPT supports GPT-4 model. Please upgrade to S plan to get access to GPT-4.
Alternatively, GPT-4 comes with ChatGPT Plus. It is limited by OpenAI to 50 requests per 3 hours. GPT-4 is also available for OpenAI API accounts.
...
- Right click HARPA icon in the browser toolbar. Make sure "This Can Read and Change Site Data" option is set to "On all sites".
- uBlock may prevent HARPA from loading on some websites. Try turning it off for the web page.
- If you are on Chrome : Navigate to chrome://settings/content/popups Add your domain to Allow list.
- Navigate to chrome://settings/content/popups
- Add your domain to Allow list.
- If you are on Brave : Navigate to brave://settings/shields Either deactivate “Prevent sites from fingerprinting me based on my language preferences” option, or deactivate Brave Shields for your domain, e.g. Discord.
...
- If you are on Edge : Navigate to edge://settings/content/ads Either deactivate "Intrusive Ads" block or add your domain to Allow list.
...
- You downloaded a CRX file and installing it manually. CRX files downloaded online may be broken or insecure. We recommend installing HARPA from the official Chrome Web Store.
- You are using NordVPN with the "THREAT PROTECT" is ON. Turn it OFF while installing HARPA extension.
...
HARPA UI is currently available in English only. We will internationalize and translate the user interface to Spanish, French, German and other languages once all the major features are implemented.
