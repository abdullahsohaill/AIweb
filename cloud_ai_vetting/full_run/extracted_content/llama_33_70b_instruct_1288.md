...
**Page Title:** Llama 3.3 70B Instruct (free) - API, Providers, Stats | OpenRouter
--------------------
...
Model Card
[LINK: Model Card](https://github.com/meta-llama/llama-models/blob/main/models/llama3_3/MODEL_CARD.md)
...
## Performance for Llama 3.3 70B Instruct (free)
...
## Apps using Llama 3.3 70B Instruct (free)

### Top public apps this month

[LINK: Company Info Collector](/apps?url=https%3A%2F%2Fgithub.com%2Fcompany-info-collector)

## Recent activity on Llama 3.3 70B Instruct (free)

### Total usage per day on OpenRouter

Prompt tokens measure input size. Reasoning tokens show internal thinking before a response. Completion tokens reflect total output length.

## Uptime stats for Llama 3.3 70B Instruct (free)

### Uptime stats for Llama 3.3 70B Instruct (free) across all providers
...
## Sample code and API for Llama 3.3 70B Instruct (free)
