...
**Page Title:** stabilityai/stable-video-diffusion-img2vid-xt · Hugging Face
--------------------
...
[LINK: f8-decoder](https://huggingface.co/docs/diffusers/api/models/autoencoderkl#loading-from-the-original-format)
...
## Model tree for stabilityai/stable-video-diffusion-img2vid-xt

## Spaces using stabilityai/stable-video-diffusion-img2vid-xt 100

## Collection including stabilityai/stable-video-diffusion-img2vid-xt
