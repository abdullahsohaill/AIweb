# Nmap
**URL:** https://nmap.org
**Page Title:** Nmap: the Network Mapper - Free Security Scanner
--------------------
...
movies , including The Matrix Reloaded , Die Hard 4 , Girl With the Dragon Tattoo ,
...
[LINK: documentation page](/docs.html)
- Powerful : Nmap has been used to scan huge networks of
literally hundreds of thousands of machines.
- Portable : Most operating systems are supported, including Linux , Microsoft Windows , FreeBSD , OpenBSD , Solaris , IRIX , Mac OS X , HP-UX , NetBSD , Sun OS , Amiga ,
and more.
...
- Acclaimed : Nmap has won numerous awards, including "Information Security Product of the Year" by Linux Journal , Info
...
series.  Visit the press page for further details.
...
Nmap users are encouraged to subscribe to the Nmap-hackers mailing list.  It is a low volume (6 posts in 2017), moderated list
