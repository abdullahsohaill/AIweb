...
**Page Title:** NousResearch/Hermes-3-Llama-3.1-70B · Hugging Face
--------------------
...
## Model tree for NousResearch/Hermes-3-Llama-3.1-70B

Base model

## Spaces using NousResearch/Hermes-3-Llama-3.1-70B 25

## Collection including NousResearch/Hermes-3-Llama-3.1-70B

## Paper for NousResearch/Hermes-3-Llama-3.1-70B
...
NousResearch/Hermes-3-Llama-3.1-70B is supported by the following Inference Providers:
