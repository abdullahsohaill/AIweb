...
**Page Title:** Qwen3 Coder 480B A35B (free) - API, Providers, Stats | OpenRouter
--------------------
...
## Providers for Qwen3 Coder 480B A35B (free)

### OpenRouter routes requests to the best providers that are able to handle your prompt size and parameters, with fallbacks to maximize uptime .

[LINK: routes requests](/docs/provider-routing)

## Performance for Qwen3 Coder 480B A35B (free)
...
## Apps using Qwen3 Coder 480B A35B (free)

### Top public apps this month

[LINK: Roo Code](/apps?url=https%3A%2F%2Fgithub.com%2FRooVetGit%2FRoo-Cline)

## Recent activity on Qwen3 Coder 480B A35B (free)

### Total usage per day on OpenRouter

Prompt tokens measure input size. Reasoning tokens show internal thinking before a response. Completion tokens reflect total output length.

## Uptime stats for Qwen3 Coder 480B A35B (free)

### Uptime stats for Qwen3 Coder 480B A35B (free) across all providers
...
## Sample code and API for Qwen3 Coder 480B A35B (free)
