...
**URL:** https://huggingface.co/Qwen/Qwen2.5-Math-72B-Instruct
**Page Title:** Qwen/Qwen2.5-Math-72B-Instruct · Hugging Face
--------------------
...
## Model tree for Qwen/Qwen2.5-Math-72B-Instruct

Base model

## Spaces using Qwen/Qwen2.5-Math-72B-Instruct 15

## Collection including Qwen/Qwen2.5-Math-72B-Instruct

## Paper for Qwen/Qwen2.5-Math-72B-Instruct
