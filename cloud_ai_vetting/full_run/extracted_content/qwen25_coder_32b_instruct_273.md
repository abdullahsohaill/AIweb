...
**Page Title:** Qwen/Qwen2.5-Coder-32B-Instruct · Hugging Face
--------------------
...
## Model tree for Qwen/Qwen2.5-Coder-32B-Instruct

Base model

## Spaces using Qwen/Qwen2.5-Coder-32B-Instruct 100

## Collection including Qwen/Qwen2.5-Coder-32B-Instruct

## Papers for Qwen/Qwen2.5-Coder-32B-Instruct
...
Qwen/Qwen2.5-Coder-32B-Instruct is supported by the following Inference Providers:
