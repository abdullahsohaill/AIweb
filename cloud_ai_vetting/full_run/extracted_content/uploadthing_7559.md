# UploadThing
**URL:** https://docs.uploadthing.com
**Page Title:** UploadThing Docs - UploadThing Docs
--------------------
...
To get started, create a new application on the UploadThing Dashboard ↗ and grab an API
...
Read more
[LINK: Read more](/api-reference/react)

### Vue

The Progressive JavaScript Framework
Read more
[LINK: Read more](https://github.com/pingdotgg/uploadthing/tree/main/examples/backend-adapters/client-vue)
...
Read more
[LINK: Read more](/api-reference/client)
