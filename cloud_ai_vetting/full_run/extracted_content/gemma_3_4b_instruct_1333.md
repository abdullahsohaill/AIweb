...
**Page Title:** Gemma 3 4B (free) - API, Providers, Stats | OpenRouter
--------------------
...
## Apps using Gemma 3 4B (free)

### Top public apps this month

## Recent activity on Gemma 3 4B (free)

### Total usage per day on OpenRouter

Prompt tokens measure input size. Reasoning tokens show internal thinking before a response. Completion tokens reflect total output length.

## Uptime stats for Gemma 3 4B (free)

### Uptime stats for Gemma 3 4B (free) on the only provider
...
## Sample code and API for Gemma 3 4B (free)
