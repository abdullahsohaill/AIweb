# Clerk Setup
**URL:** https://go.clerk.com/sonny
**Page Title:** Clerk | Authentication and User Management
--------------------
...
[LINK: Start building for free](https://clerk.com/docs/quickstart)
...
[LINK: Explore all components](/docs/components/overview)
...
[LINK: All frameworks](/docs#frontend-frameworks)
[LINK: Next.js](/docs/nextjs/getting-started/quickstart)
[LINK: React](/docs/react/getting-started/quickstart)
[LINK: Expo](/docs/expo/getting-started/quickstart)
[LINK: React Router](/docs/react-router/getting-started/quickstart)
[LINK: TanStack React Start](/docs/tanstack-react-start/getting-started/quickstart)
[LINK: Astro](/docs/astro/getting-started/quickstart)
...
[LINK: All integrations](/docs/integrations/overview)
[LINK: Supabase](/docs/guides/development/integrations/databases/supabase)
[LINK: Convex](/docs/guides/development/integrations/databases/convex)
[LINK: Vercel](/docs/guides/development/integrations/platforms/vercel-marketplace)

## What people are saying

Trusted by startups and the world's largest companies
Join the growing number of customers and champions who trust Clerk for authentication and user management.
- The best practices built-in to their <SignIn/> and <UserProfile/> components would take months to implement in-house, yet no sacrifice is made in terms of Enterprise extensibility or customization to your brand. Name Guillermo Rauch Role CEO Company Vercel
...
- Clerk feels like the first time I booted my computer with an SSD. It’s so much faster and simpler that it changed how I do things. Name Theo Browne Role CEO Company Ping Labs
...
- After spending many hours on auth issues that seemed simple (but were not), we moved to Clerk and all that burden was lifted. We kind of wish we’d made that decision earlier. Name Julian Benegas Role CEO Company BaseHub
...
- Clerk let us spin up a new product in hours instead of weeks. As a company that deeply values developer velocity— Clerk is exactly what we needed. Name Kevin Van Gundy Role CEO Company Hypermode
...
- We’re big admirers of what the @clerk team are building and looking forward to working more closely with them. Name Patrick Collison Role CEO Company Stripe
We’re big admirers of what the @clerk team are building and looking forward to working more closely with them.
- Clerk’s integration gives Supabase developers another incredible option for handling authentication. And the Clerk team are a pleasure to work with. Name Paul Copplestone Role CEO Company Supabase
...
- We were able to ship MFA, SSO, and SAML for our customers in a fraction of the time. Now, we have improved security and must-haves for enterprise prospects. Name Dan Farrelly Role CTO Company Inngest
...
- Managed to integrate AppSync with @clerk over the weekend. Implementing a Lambda authorizer with Clerk’s Go SDK was super easy. Name Mathias Lafeldt Role Founder Company Grafbase
Managed to integrate AppSync with @clerk over the weekend. Implementing a Lambda authorizer with Clerk’s Go SDK was super easy.
...
[LINK: Start building](https://clerk.com/docs/quickstart)
