...
**Page Title:** Qwen/Qwen2.5-1.5B-Instruct · Hugging Face
--------------------
...
## Model tree for Qwen/Qwen2.5-1.5B-Instruct

Base model

## Spaces using Qwen/Qwen2.5-1.5B-Instruct 100

## Collection including Qwen/Qwen2.5-1.5B-Instruct

## Paper for Qwen/Qwen2.5-1.5B-Instruct
...
Qwen/Qwen2.5-1.5B-Instruct is supported by the following Inference Providers:
