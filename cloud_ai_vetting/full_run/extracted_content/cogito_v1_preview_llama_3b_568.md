...
**Page Title:** deepcogito/cogito-v1-preview-llama-3B · Hugging Face
--------------------
...
[LINK: Llama 3.2 Community License Agreement](https://github.com/meta-llama/llama-models/blob/main/models/llama3_2/LICENSE)

## Contact

If you would like to reach out to our team, send an email to contact@deepcogito.com .

## Model tree for deepcogito/cogito-v1-preview-llama-3B

Base model

## Spaces using deepcogito/cogito-v1-preview-llama-3B 3

## Collection including deepcogito/cogito-v1-preview-llama-3B
