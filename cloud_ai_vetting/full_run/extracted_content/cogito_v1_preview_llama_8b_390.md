...
**Page Title:** deepcogito/cogito-v1-preview-llama-8B · Hugging Face
--------------------
...
This repository and the model weights are licensed under the Llama 3.1 Community License Agreement (Llama models' default license agreement).
[LINK: Llama 3.1 Community License Agreement](https://github.com/meta-llama/llama-models/blob/main/models/llama3_1/LICENSE)

## Contact

If you would like to reach out to our team, send an email to contact@deepcogito.com .

## Model tree for deepcogito/cogito-v1-preview-llama-8B

Base model

## Space using deepcogito/cogito-v1-preview-llama-8B 1

## Collection including deepcogito/cogito-v1-preview-llama-8B
...
deepcogito/cogito-v1-preview-llama-8B is supported by the following Inference Providers:
