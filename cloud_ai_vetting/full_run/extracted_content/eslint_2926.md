# ESLint
**URL:** http://eslint.org
**Page Title:** Find and fix problems in your JavaScript code - ESLint - Pluggable JavaScript Linter
--------------------
...
[LINK: Get Started](/docs/latest/use/getting-started)
[LINK: v9.39.2](https://github.com/eslint/eslint/releases/tag/v9.39.2)
[LINK: v10.0.0-rc.1](https://github.com/eslint/eslint/releases/tag/v10.0.0-rc.1)

### Find issues

ESLint statically analyzes your code to quickly find problems. ESLint is built into most text editors and you can run ESLint as part of your continuous integration pipeline.
[LINK: Learn more about finding issues with ESLint](/docs/latest/use/getting-started)

### Fix problems automatically

Many problems ESLint finds can be automatically fixed. ESLint fixes are syntax-aware so you won't experience errors introduced by traditional find-and-replace algorithms.
[LINK: Learn more about fixing problems automatically with ESLint](/docs/latest/use/command-line-interface#fix-problems)
...
[LINK: Learn more about configuring ESLint](/docs/latest/use/configure/)
...
- JEmilyKoo January 25, 2026 + $5.00
JEmilyKoo
January 25, 2026
- Youngjae Kim January 25, 2026 + $5.00
Youngjae Kim
January 25, 2026
- Haeun Kim January 25, 2026 + $5.00
Haeun Kim
January 25, 2026
- Chrome's Web Framework & Tools Performance Fund January 22, 2026 + $10,000.00
Chrome's Web Framework & Tools Performance Fund
January 22, 2026
- Oğuzhan Çakıroğlu January 17, 2026 + $1.00
Oğuzhan Çakıroğlu
January 17, 2026
- THANKS.DEV January 7, 2026 + $9,875.87
THANKS.DEV
January 7, 2026
