...
**Page Title:** Qwen/Qwen2.5-14B-Instruct · Hugging Face
--------------------
...
## Model tree for Qwen/Qwen2.5-14B-Instruct

Base model

## Spaces using Qwen/Qwen2.5-14B-Instruct 100

## Collection including Qwen/Qwen2.5-14B-Instruct

## Papers for Qwen/Qwen2.5-14B-Instruct
...
Qwen/Qwen2.5-14B-Instruct is supported by the following Inference Providers:
