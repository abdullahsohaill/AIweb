...
**Page Title:** OpenGVLab/InternVL2-1B · Hugging Face
--------------------
...
InternVL 2.0 is a multimodal large language model series, featuring models of various sizes. For each size, we release instruction-tuned models optimized for multimodal tasks. InternVL2-1B consists of InternViT-300M-448px , an MLP projector, and Qwen2-0.5B-Instruct .
...
## Model tree for OpenGVLab/InternVL2-1B

## Spaces using OpenGVLab/InternVL2-1B 4

## Collection including OpenGVLab/InternVL2-1B

## Papers for OpenGVLab/InternVL2-1B
