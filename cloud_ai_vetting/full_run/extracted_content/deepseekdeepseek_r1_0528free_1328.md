...
**Page Title:** R1 0528 (free) - API, Providers, Stats | OpenRouter
--------------------
...
## Apps using R1 0528 (free)

### Top public apps this month

[LINK: New API](/apps?url=https%3A%2F%2Fwww.newapi.ai%2F)

## Recent activity on R1 0528 (free)

### Total usage per day on OpenRouter

Prompt tokens measure input size. Reasoning tokens show internal thinking before a response. Completion tokens reflect total output length.

## Uptime stats for R1 0528 (free)

### Uptime stats for R1 0528 (free) on the only provider
...
## Sample code and API for R1 0528 (free)
