...
**Page Title:** gpt-oss-20b (free) - API, Providers, Stats | OpenRouter
--------------------
...
[LINK: LogPrompt](/apps?url=https%3A%2F%2Fgithub.com%2FLogPrompt)
...
### Uptime stats for gpt-oss-20b (free) on the only provider
