...
**Page Title:** openai/whisper-base · Hugging Face
--------------------
...
## Model tree for openai/whisper-base

## Spaces using openai/whisper-base 100

## Collection including openai/whisper-base

## Paper for openai/whisper-base

## Evaluation results

- Test WER on LibriSpeech (clean) test set self-reported 5.009
- Test WER on LibriSpeech (other) test set self-reported 12.849
- Test WER on Common Voice 11.0 test set self-reported 131.000
