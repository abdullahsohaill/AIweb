...
**Page Title:** ibm-granite/granite-34b-code-instruct-8k · Hugging Face
--------------------
...
## Model tree for ibm-granite/granite-34b-code-instruct-8k

Base model

## Datasets used to train ibm-granite/granite-34b-code-instruct-8k

## Space using ibm-granite/granite-34b-code-instruct-8k 1

## Collection including ibm-granite/granite-34b-code-instruct-8k

## Paper for ibm-granite/granite-34b-code-instruct-8k

## Evaluation results

- pass@1 on HumanEvalSynthesis(Python) self-reported 62.200
- pass@1 on HumanEvalSynthesis(JavaScript) self-reported 56.700
- pass@1 on HumanEvalSynthesis(Java) self-reported 62.800
- pass@1 on HumanEvalSynthesis(Go) self-reported 47.600
- pass@1 on HumanEvalSynthesis(C++) self-reported 57.900
- pass@1 on HumanEvalSynthesis(Rust) self-reported 41.500
- pass@1 on HumanEvalExplain(Python) self-reported 53.000
- pass@1 on HumanEvalExplain(JavaScript) self-reported 45.100
- pass@1 on HumanEvalExplain(Java) self-reported 50.600
- pass@1 on HumanEvalExplain(Go) self-reported 36.000
- pass@1 on HumanEvalExplain(C++) self-reported 42.700
- pass@1 on HumanEvalExplain(Rust) self-reported 23.800
- pass@1 on HumanEvalFix(Python) self-reported 54.900
- pass@1 on HumanEvalFix(JavaScript) self-reported 47.600
- pass@1 on HumanEvalFix(Java) self-reported 55.500
- pass@1 on HumanEvalFix(Go) self-reported 51.200
- pass@1 on HumanEvalFix(C++) self-reported 47.000
- pass@1 on HumanEvalFix(Rust) self-reported 45.100
