...
**Page Title:** openai/whisper-large-v2 · Hugging Face
--------------------
...
## Model tree for openai/whisper-large-v2

## Spaces using openai/whisper-large-v2 100

## Collection including openai/whisper-large-v2

## Paper for openai/whisper-large-v2
