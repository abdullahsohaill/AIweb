...
**Page Title:** Llama 3.1 405B Instruct (free) - API, Providers, Stats | OpenRouter
--------------------
...
## Providers for Llama 3.1 405B Instruct (free)

### OpenRouter routes requests to the best providers that are able to handle your prompt size and parameters, with fallbacks to maximize uptime .

[LINK: routes requests](/docs/provider-routing)

## Performance for Llama 3.1 405B Instruct (free)
...
## Apps using Llama 3.1 405B Instruct (free)

### Top public apps this month

## Recent activity on Llama 3.1 405B Instruct (free)

### Total usage per day on OpenRouter

Prompt tokens measure input size. Reasoning tokens show internal thinking before a response. Completion tokens reflect total output length.

## Uptime stats for Llama 3.1 405B Instruct (free)

### Uptime stats for Llama 3.1 405B Instruct (free) on the only provider
...
## Sample code and API for Llama 3.1 405B Instruct (free)
