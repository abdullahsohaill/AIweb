...
[LINK: 40 other formats](//github.com/photopea/photopea?tab=readme-ov-file#supported-formats)

## Perfect RAW support

Photopea opens DNG, CR2, CR3, NEF, ARW, RW2, RAF, ORF and FFF files. Set the Exposure, Color Balance, 
						Contrast, Highlights and Shadows, etc.

## State-of-the-art AI

Remove background with one click ,
						or replace any part of an image with a new content through a text description.
