...
**Page Title:** Qwen3 4B (free) - API, Providers, Stats | OpenRouter
--------------------
...
## Apps using Qwen3 4B (free)

### Top public apps this month

## Recent activity on Qwen3 4B (free)

### Total usage per day on OpenRouter

Prompt tokens measure input size. Reasoning tokens show internal thinking before a response. Completion tokens reflect total output length.

## Uptime stats for Qwen3 4B (free)

### Uptime stats for Qwen3 4B (free) on the only provider
...
## Sample code and API for Qwen3 4B (free)
