...
**Page Title:** kyutai/moshiko-pytorch-bf16 · Hugging Face
--------------------
...
- Repository: repo
[LINK: repo](https://github.com/kyutai-labs/moshi)
- Paper: paper
- Demo: demo
...
[LINK: README](https://github.com/kyutai-labs/moshi)

## Training Details

### Training Data

- Textual data: The underlying Helium model is trained on a mix of data, more precisely: 12.5% is high-quality data sources from the following curated sources: Wikipedia Wikibooks, Wikisource, Wikinews,
...
[LINK: scientific articles pes2o](https://github.com/allenai/peS2o)
...
[LINK: Whisper](https://github.com/openai/whisper)
...
[LINK: AudioSR](https://audioldm.github.io/audiosr/)
...
## Model tree for kyutai/moshiko-pytorch-bf16

## Collection including kyutai/moshiko-pytorch-bf16
