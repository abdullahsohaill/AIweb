...
**Page Title:** Qwen/Qwen2.5-1.5B · Hugging Face
--------------------
...
## Model tree for Qwen/Qwen2.5-1.5B

## Spaces using Qwen/Qwen2.5-1.5B 100

## Collection including Qwen/Qwen2.5-1.5B

## Paper for Qwen/Qwen2.5-1.5B
...
Qwen/Qwen2.5-1.5B is supported by the following Inference Providers:
