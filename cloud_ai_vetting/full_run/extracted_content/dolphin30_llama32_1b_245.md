...
**Page Title:** dphn/Dolphin3.0-Llama3.2-1B · Hugging Face
--------------------
...
## Model tree for dphn/Dolphin3.0-Llama3.2-1B

Base model

## Datasets used to train dphn/Dolphin3.0-Llama3.2-1B

## Space using dphn/Dolphin3.0-Llama3.2-1B 1
