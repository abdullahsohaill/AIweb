...
**Page Title:** Qwen/Qwen2.5-7B-Instruct · Hugging Face
--------------------
...
## Spaces using Qwen/Qwen2.5-7B-Instruct 100

## Collection including Qwen/Qwen2.5-7B-Instruct

## Papers for Qwen/Qwen2.5-7B-Instruct
...
Qwen/Qwen2.5-7B-Instruct is supported by the following Inference Providers:
