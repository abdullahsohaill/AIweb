...
**URL:** https://huggingface.co/cognitivecomputations/Dolphin3.0-Llama3.2-3B
**Page Title:** dphn/Dolphin3.0-Llama3.2-3B · Hugging Face
--------------------
...
## Model tree for dphn/Dolphin3.0-Llama3.2-3B

Base model

## Datasets used to train dphn/Dolphin3.0-Llama3.2-3B
