# Aya Vision 8B
**URL:** https://huggingface.co/CohereForAI/aya-vision-8b
**Page Title:** CohereLabs/aya-vision-8b · Hugging Face
--------------------
...
Model Architecture: This is a vision-language model that uses a multilingual language model based on Command R7B and further post-trained with the Aya Expanse recipe , paired with SigLIP2-patch14-384 vision encoder through a multimodal adapter for vision-language understanding.
...
We evaluated Aya Vision 8B against Pangea 7B , Llama-3.2 11B Vision , Molmo-D 7B , Qwen2.5-VL 7B , Pixtral 12B , and Gemini Flash 1.5 8B using Aya Vision Benchmark and m-WildVision . 
...
[LINK: Gemini Flash 1.5 8B](https://developers.googleblog.com/en/gemini-15-flash-8b-is-now-generally-available-for-use/)
...
## Model tree for CohereLabs/aya-vision-8b

## Spaces using CohereLabs/aya-vision-8b 14

## Collection including CohereLabs/aya-vision-8b

## Paper for CohereLabs/aya-vision-8b
