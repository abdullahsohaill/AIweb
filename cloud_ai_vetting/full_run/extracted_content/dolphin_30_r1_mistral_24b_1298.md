...
**Page Title:** Dolphin3.0 R1 Mistral 24B - API, Providers, Stats | OpenRouter
--------------------
...
Part of the Dolphin 3.0 Collection Curated and trained by Eric Hartford , Ben Gitter , BlouseJury and DphnAI

## Recent activity on Dolphin3.0 R1 Mistral 24B

### Total usage per day on OpenRouter

### Not enough data to display yet.

## More models from Cognitive Computations
