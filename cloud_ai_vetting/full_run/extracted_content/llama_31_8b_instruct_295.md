...
**Page Title:** meta-llama/Llama-3.1-8B-Instruct · Hugging Face
--------------------
...
[LINK: huggingface-llama-recipes](https://github.com/huggingface/huggingface-llama-recipes)
...
## Model tree for meta-llama/Llama-3.1-8B-Instruct

Base model

## Spaces using meta-llama/Llama-3.1-8B-Instruct 100

## Collections including meta-llama/Llama-3.1-8B-Instruct

## Paper for meta-llama/Llama-3.1-8B-Instruct

## Evaluation results

- Diamond on Idavidrein/gpqa community leaderboard 30.400
- Gsm8k on openai/gsm8k community leaderboard 84.500
- Mmlu Pro on TIGER-Lab/MMLU-Pro community leaderboard 48.300
...
meta-llama/Llama-3.1-8B-Instruct is supported by the following Inference Providers:
