# InternVL2_5-26B-MPO
**URL:** https://huggingface.co/OpenGVLab/InternVL2_5-26B-MPO
**Page Title:** OpenGVLab/InternVL2_5-26B-MPO · Hugging Face
--------------------
...
We provide an example code to run InternVL2_5-26B-MPO using transformers .
...
## Model tree for OpenGVLab/InternVL2_5-26B-MPO

Base model

## Dataset used to train OpenGVLab/InternVL2_5-26B-MPO

## Collection including OpenGVLab/InternVL2_5-26B-MPO

## Papers for OpenGVLab/InternVL2_5-26B-MPO
