# MJML
**URL:** https://mjml.io
**Page Title:** MJML - The Responsive Email Framework
--------------------
...
## Write less, save time and code more efficiently

MJML is responsive by design on most-popular email clients,
even Outlook. Write less code, save time and code more efficiently with MJML’s
semantic syntax.
“We decided to use MJML as the framework for our Figma Plugin due to its simplicity, support for a wide range of email clients, and component-based structure. It’s also a widely used and well-supported framework. We ❤️ you, MJML!”
Andy King, Principal & Head Curator
...
These days, we email everywhere - standing up, sitting down, sleeping...and on a ton of devices too. Beyond the third screen (mobile), we’re moving onto smart watches and possibly even VR devices!
...
### Why we set out to tackle the challenge of coding responsive email
...
[LINK: React.js](https://facebook.github.io/react/)
