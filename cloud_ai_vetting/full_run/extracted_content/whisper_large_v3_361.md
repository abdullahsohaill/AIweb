...
**Page Title:** openai/whisper-large-v3 · Hugging Face
--------------------
...
## Model tree for openai/whisper-large-v3

## Spaces using openai/whisper-large-v3 100

## Paper for openai/whisper-large-v3
