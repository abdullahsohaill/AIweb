...
**Page Title:** Supabase | The Postgres Development Platform.
--------------------
...
- OpenAI
- Hugging Face
[LINK: Data APIs Instant ready-to-use Restful APIs .](https://supabase.com/docs/guides/api)
...
[LINK: View all examples](/docs/guides/examples)
[LINK: Official GitHub library](https://github.com/supabase/supabase/tree/master/examples)
[LINK: Stripe Subscriptions Starter The all-in-one subscription starter kit for high-performance SaaS applications, powered by Stripe, Supabase, and Vercel.](https://github.com/supabase-community/nextjs-subscription-payments)
The all-in-one subscription starter kit for high-performance SaaS applications, powered by Stripe, Supabase, and Vercel.
[LINK: Next.js Starter A Next.js App Router template configured with cookie-based auth using Supabase, TypeScript and Tailwind CSS.](https://github.com/vercel/next.js/tree/canary/examples/with-supabase)
A Next.js App Router template configured with cookie-based auth using Supabase, TypeScript and Tailwind CSS.
[LINK: AI Chatbot An open-source AI chatbot app template built with Next.js, the Vercel AI SDK, OpenAI, and Supabase.](https://github.com/supabase-community/vercel-ai-chatbot)
An open-source AI chatbot app template built with Next.js, the Vercel AI SDK, OpenAI, and Supabase.
[LINK: LangChain + Next.js Starter Starter template and example use-cases for LangChain projects in Next.js, including chat, agents, and retrieval.](https://github.com/langchain-ai/langchain-nextjs-template)
Starter template and example use-cases for LangChain projects in Next.js, including chat, agents, and retrieval.
[LINK: Flutter User Management Get started with Supabase and Flutter by building a user management app with auth, file storage, and database.](https://github.com/supabase/supabase/tree/master/examples/user-management/flutter-user-management)
Get started with Supabase and Flutter by building a user management app with auth, file storage, and database.
[LINK: Expo React Native Starter An extended version of create-t3-turbo implementing authentication on both the web and mobile applications.](https://github.com/supabase-community/create-t3-turbo)
...
- Full CRUD
[LINK: Full CRUD](/docs/guides/database/tables?queryGroups=database-method&database-method=sql&queryGroups=language&language=js)
- Materialized Views
[LINK: Materialized Views](/docs/guides/database/tables?queryGroups=database-method&database-method=sql&queryGroups=language&language=js#materialized-views)
- Foreign Tables
[LINK: Foreign Tables](/docs/guides/database/tables?queryGroups=database-method&database-method=sql&queryGroups=language&language=js#joining-tables-with-foreign-keys)
- Partitioned Tables
[LINK: Partitioned Tables](/docs/guides/database/partitions)
- Easy as a spreadsheet
[LINK: Easy as a spreadsheet](/docs/guides/database/overview#table-view)
...
@adm_lawson
Love supabse edge functions. Cursor+Supabase+MCP+Docker desktop is all I need
@gokul_i
...
@Rodrigo66799141
After a week of diving deep into Supabase for my new SaaS project, I'm really impressed with its Auth and RLS features. It makes security much simpler for solo founders. #buildinpublic #SaaS
@xthemadgeniusx
Lately been using Supabase over AWS/ GCP for products to save on costs and rapid builds(Vibe Code) that do not need all the Infra and the hefty costs that come with AWS/ GCP out the door. Great solution overall.
@pontusab
I love everything about Supabase.
@viratt_mankali
Love how Supabase makes full stack features this easy. Using it with Next.js and loving the experience!
@nerdburn
It’s fun, feels lightweight, and really quick to spin up user auth and a few tables. Almost too easy! Highly recommend.
@patrickc
Very impressed by @supabase's growth. For new startups, they seem to have gone from "promising" to "standard" in remarkably short order.
...
[LINK: @supabase 96.6K](https://github.com/supabase)
