...
**Page Title:** deepcogito/cogito-v1-preview-llama-70B · Hugging Face
--------------------
...
This repository and the model weights are licensed under the Llama 3.3 Community License Agreement (Llama models' default license agreement).
[LINK: Llama 3.3 Community License Agreement](https://github.com/meta-llama/llama-models/blob/main/models/llama3_3/LICENSE)

## Contact

If you would like to reach out to our team, send an email to contact@deepcogito.com .

## Model tree for deepcogito/cogito-v1-preview-llama-70B

Base model

## Collection including deepcogito/cogito-v1-preview-llama-70B
...
deepcogito/cogito-v1-preview-llama-70B is supported by the following Inference Providers:
