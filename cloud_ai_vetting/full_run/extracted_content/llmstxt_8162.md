...
**Page Title:** The /llms.txt file – llms-txt
--------------------
...
[LINK: FastHTML docs llms.txt](https://www.fastht.ml/docs/llms.txt)
[LINK: regular HTML docs page](https://www.fastht.ml/docs/tutorials/by_example.html)
[LINK: a .md extension](https://www.fastht.ml/docs/tutorials/by_example.html.md)
...
[LINK: llms-ctx.txt](https://fastht.ml/docs/llms-ctx.txt)
[LINK: llms-ctx-full.txt](https://fastht.ml/docs/llms-ctx-full.txt)
...
[LINK: full version](https://www.fastht.ml/docs/llms.txt)
...
[LINK: vitepress-plugin-llms](https://github.com/okineadev/vitepress-plugin-llms)
- docusaurus-plugin-llms - Docusaurus plugin for generating LLM-friendly documentation following the llmtxt.org standard
[LINK: docusaurus-plugin-llms](https://github.com/rachfop/docusaurus-plugin-llms)
...
[LINK: llms-txt-php](https://github.com/raphaelstolt/llms-txt-php)
...
[LINK: VS Code PagePilot Extension](https://dmux.github.io/pagepilot)
...
[LINK: GitHub repository](https://github.com/AnswerDotAI/llms-txt)
[LINK: this informal overview](https://github.com/AnswerDotAI/llms-txt/blob/main/nbs/index.qmd)
