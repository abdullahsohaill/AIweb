...
**URL:** https://huggingface.co/cognitivecomputations/Dolphin3.0-Qwen2.5-3b
**Page Title:** dphn/Dolphin3.0-Qwen2.5-3b · Hugging Face
--------------------
...
## Model tree for dphn/Dolphin3.0-Qwen2.5-3b

Base model

## Datasets used to train dphn/Dolphin3.0-Qwen2.5-3b
