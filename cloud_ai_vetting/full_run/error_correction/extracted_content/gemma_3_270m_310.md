...
**Page Title:** Introducing Gemma 3 270M: The compact model for hyper-efficient AI - Google Developers Blog
--------------------
...
- Facebook
[LINK: Facebook](https://www.facebook.com/sharer/sharer.php?u=https://developers.googleblog.com/en/introducing-gemma-3-270m/)
- Twitter
[LINK: Twitter](https://twitter.com/intent/tweet?text=https://developers.googleblog.com/en/introducing-gemma-3-270m/)
- LinkedIn
[LINK: LinkedIn](https://www.linkedin.com/shareArticle?url=https://developers.googleblog.com/en/introducing-gemma-3-270m/&mini=true)
- Mail
[LINK: Mail](mailto:name@example.com?subject=Check%20out%20this%20site&body=Check%20out%20https://developers.googleblog.com/en/introducing-gemma-3-270m/)
...
[LINK: Gemma 3](https://blog.google/technology/developers/gemma-3/)
[LINK: Gemma 3 QAT](https://developers.googleblog.com/en/gemma-3-quantized-aware-trained-state-of-the-art-ai-to-consumer-gpus/)
[LINK: Gemma 3n](https://developers.googleblog.com/en/introducing-gemma-3n/)
...
[LINK: Gemma 3 270M](https://ai.google.dev/gemma/docs/core/huggingface_text_full_finetune)
...
[LINK: Quantization-Aware Trained](https://developers.googleblog.com/en/gemma-3-quantized-aware-trained-state-of-the-art-ai-to-consumer-gpus/)
...
[LINK: full fine-tuning](https://ai.google.dev/gemma/docs/core/huggingface_text_full_finetune)
...
[LINK: Hugging Face](http://ai.google.dev/gemma/docs/core/huggingface_text_full_finetune)
[LINK: UnSloth](https://docs.unsloth.ai/basics/gemma-3-how-to-run-and-fine-tune)
[LINK: JAX.](https://gemma-llm.readthedocs.io/en/latest/colab_finetuning.html)
...
[LINK: Google Cloud Run](https://cloud.google.com/run/docs/run-gemma-on-cloud-run)
