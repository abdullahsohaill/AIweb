...
**URL:** https://openvinotoolkit.github.io/openvino.genai/docs/getting-started/installation
**Page Title:** Install OpenVINO GenAI | OpenVINO GenAI
--------------------

OpenVINO GenAI is available for installation via PyPI , Archive and npm distributions and supports Linux, Windows and macOS platforms.
- PyPI
- Archive
- npm
Some models may require additional dependencies.
See the Model Preparation Guide for details.
[LINK: Model Preparation Guide](/openvino.genai/docs/guides/model-preparation/convert-to-openvino)
- Download OpenVINO GenAI archive .
- Follow the Archive Installation instructions .
[LINK: Archive Installation instructions](https://docs.openvino.ai/2025/get-started/install-openvino/install-openvino-genai.html#archive-installation)
See the Node.js Bindings for more information.
[LINK: Node.js Bindings](/openvino.genai/docs/bindings/node-js)
Refer to the Install Guide for detailed instructions.
[LINK: Install Guide](https://docs.openvino.ai/2025/get-started/install-openvino.html)
To build OpenVINO GenAI library from source, refer to the Build Instructions .
[LINK: Build Instructions](https://github.com/openvinotoolkit/openvino.genai/blob/master/src/docs/BUILD.md)
...
[LINK: OpenVINO System Requirements](https://docs.openvino.ai/2025/about-openvino/release-notes-openvino/system-requirements.html)

## OpenVINO GenAI Dependencies ​

OpenVINO GenAI depends on OpenVINO and OpenVINO Tokenizers .
[LINK: OpenVINO](https://github.com/openvinotoolkit/openvino)
[LINK: OpenVINO Tokenizers](https://github.com/openvinotoolkit/openvino_tokenizers)
