...
[LINK: Tatsunori Hashimoto](https://thashim.github.io/)
Instructor
...
[LINK: Rishi Bommasani](https://rishibommasani.github.io/)
Course Assistant
...
Video access disclaimer : A portion of class activities will be given and recorded in Zoom. For your convenience, you can access these recordings by logging into the course Canvas site. These recordings might be reused in other Stanford courses, viewed by other Stanford students, faculty, or staff, or used for other education and research purposes. If you have questions, please contact a member of the teaching team at cs324-win2122-staff@lists.stanford.edu .

## Class

Each class is divided into two parts:
- Lecture (45 minutes): an instructor gives a standard lecture on a topic (see the calendar for the list of topics). Lectures are be based on these lecture notes .
Lecture (45 minutes): an instructor gives a standard lecture on a topic (see the calendar for the list of topics). Lectures are be based on these lecture notes .
- Discussion (45 minutes): there is a student panel discussion on the required readings posted on the calendar .
Discussion (45 minutes): there is a student panel discussion on the required readings posted on the calendar .
