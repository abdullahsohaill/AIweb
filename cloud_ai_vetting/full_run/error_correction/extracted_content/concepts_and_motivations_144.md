...
**URL:** https://synaptiai.github.io/uim-protocol/specification
**Page Title:** UIM Protocol Specification - Unified Intent Mediator (UIM) Protocol
--------------------

[LINK: Skip to content](https://synaptiai.github.io/uim-protocol/specification/#uim-protocol-specification)
...
[LINK: Overview](https://synaptiai.github.io/uim-protocol/specification/overview/)
- Key Concepts : Core concepts including intents, metadata, and the execute method
[LINK: Key Concepts](https://synaptiai.github.io/uim-protocol/specification/key-concepts/)
- Architecture : System architecture options including centralized, decentralized, and hybrid approaches
[LINK: Architecture](https://synaptiai.github.io/uim-protocol/specification/architecture/)
- Core Components : Detailed specifications for each component of the protocol
[LINK: Core Components](https://synaptiai.github.io/uim-protocol/specification/core-components/)
- API Guidelines : Standards and best practices for API implementation
[LINK: API Guidelines](https://synaptiai.github.io/uim-protocol/specification/api-guidelines/)
- Security : Security considerations and implementation guidelines
[LINK: Security](https://synaptiai.github.io/uim-protocol/specification/security/)
- Appendix : Additional resources, examples, and reference materials
[LINK: Appendix](https://synaptiai.github.io/uim-protocol/specification/appendix/)
...
[LINK: GitHub repository](https://github.com/synaptiai/uim-protocol)
...
[LINK: formal UIM Protocol specification document](https://synaptiai.github.io/uim-protocol/specification/uim-specification.txt)
