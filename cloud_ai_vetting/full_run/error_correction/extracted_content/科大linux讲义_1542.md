...
- 记号约定 中约定了本书中常用的符号与注记形式。在研读本书的过程中可随时参考。
- 功劳簿 列出了所有为编写本书做出贡献的朋友们。
- Linux 101 活动于 2020 年的直播记录视频可以在 LUG FTP 找到，也可以在 YouTube 上在线观看。
- 对于服务器运维等较为深入的应用场景，我们另外启动了《 Linux 201 》项目，作为本书的进阶版，可供感兴趣的读者参考。

## 联系我们 ¶

本书的成长离不开大家的帮助。本书的源代码存放在 Linux101-docs 仓库 中，所有内容以 CC BY-SA 4.0 协议 开放。
[LINK: Linux101-docs 仓库](https://github.com/ustclug/Linux101-docs)
若您对本书有任何意见或建议，可以在本书的 GitHub 仓库中提出 Issue，也欢迎致信 ，我们重视您的想法。
