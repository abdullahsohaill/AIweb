...
- [GitHub](https://docs.cdp.coinbase.com/agent-kit/github/agentkit-repo.md)
...
- [Create payment link](https://docs.cdp.coinbase.com/api-reference/business-api/rest-api/payment-links/create-payment-link.md): Generate a new payment link for checkout.
- [Deactivate Payment Link](https://docs.cdp.coinbase.com/api-reference/business-api/rest-api/payment-links/deactivate-payment-link.md): Deactivates a payment link, preventing it from accepting further payments. Only `ACTIVE` payment links can be deactivated.
- [Get Payment Link](https://docs.cdp.coinbase.com/api-reference/business-api/rest-api/payment-links/get-payment-link.md): Retrieves details of a specific payment link by ID.
- [Payment Link API Reference](https://docs.cdp.coinbase.com/api-reference/business-api/rest-api/payment-links/introduction.md)
- [null](https://docs.cdp.coinbase.com/api-reference/business-api/rest-api/payment-links/list-payment-links.md)
...
- [Overview](https://docs.cdp.coinbase.com/api-reference/payment-apis/overview.md): APIs for managing accounts, deposit destinations, payment methods, transfers, and webhooks for payment processing.
- [Link account](https://docs.cdp.coinbase.com/api-reference/payment-apis/rest-api/accounts-under-development/link-account-to-cdp-for-the-current-entity.md): Links the specified account from Coinbase Business or Coinbase Prime to CDP so that it can be used in the context of CDP products.
- [List linkable accounts](https://docs.cdp.coinbase.com/api-reference/payment-apis/rest-api/accounts-under-development/list-linkable-accounts-for-the-current-entity.md): Returns a list of accounts from Coinbase Business or Coinbase Prime that can be linked to CDP for the current entity.
- [Accounts](https://docs.cdp.coinbase.com/api-reference/payment-apis/rest-api/accounts/accounts.md)
- [Payment Methods](https://docs.cdp.coinbase.com/api-reference/payment-apis/rest-api/payment-methods/payment-methods.md)
- [Create webhook subscription](https://docs.cdp.coinbase.com/api-reference/payment-apis/rest-api/webhooks-under-development/create-webhook-subscription.md): Subscribe to real-time events across CDP products using flexible filtering.
...
- [Delete webhook subscription](https://docs.cdp.coinbase.com/api-reference/payment-apis/rest-api/webhooks-under-development/delete-webhook-subscription.md): Permanently delete a webhook subscription and stop all event deliveries.
...
- [Get webhook subscription details](https://docs.cdp.coinbase.com/api-reference/payment-apis/rest-api/webhooks-under-development/get-webhook-subscription-details.md): Retrieve detailed information about a specific webhook subscription including
...
- [List webhook subscriptions](https://docs.cdp.coinbase.com/api-reference/payment-apis/rest-api/webhooks-under-development/list-webhook-subscriptions.md): Retrieve a paginated list of webhook subscriptions for the authenticated project.
...
- [Update webhook subscription](https://docs.cdp.coinbase.com/api-reference/payment-apis/rest-api/webhooks-under-development/update-webhook-subscription.md): Update an existing webhook subscription's configuration including
...
- [Webhooks](https://docs.cdp.coinbase.com/api-reference/payment-apis/rest-api/webhooks/webhooks.md)
- [What We Support](https://docs.cdp.coinbase.com/api-reference/payment-apis/what-we-support.md): Supported payment flows, currencies, networks, and payment methods for CDP Payments API.
...
- [Get Cross Margin Overview](https://docs.cdp.coinbase.com/api-reference/prime-api/rest-api/financing/get-cross-margin-overview.md): Gets live data for Cross Margin (XM) for a specific XM customer
...
- [Get Public Product Candles (Beta)](https://docs.cdp.coinbase.com/api-reference/prime-api/rest-api/products/get-public-product-candles-beta.md): Get rates for a single product by product ID, grouped in buckets. This feature is in beta please reach out to your Coinbase Prime account manager for more information.
...
- [Claim Wallet Staking Rewards](https://docs.cdp.coinbase.com/api-reference/prime-api/rest-api/staking/claim-wallet-staking-rewards-alpha.md): Request to claim staking rewards. This feature is in alpha. Please reach out to your Coinbase Prime account manager for more information
...
- [Request to claim rewards for a staked wallet](https://docs.cdp.coinbase.com/api-reference/prime-api/rest-api/staking/request-to-claim-rewards-for-a-staked-wallet.md): Request to claim staking rewards. This feature is in alpha. Please reach out to your Coinbase Prime account manager for more information
...
- [Add a Solana account to an end user](https://docs.cdp.coinbase.com/api-reference/v2/rest-api/end-user-accounts/add-a-solana-account-to-an-end-user.md): Adds a new Solana account to an existing end user. End users can have  up to 10 Solana accounts.
This API is intended to be used by the developer's own backend, and is authenticated using the developer's CDP API key.
- [Add an EVM account to an end user](https://docs.cdp.coinbase.com/api-reference/v2/rest-api/end-user-accounts/add-an-evm-account-to-an-end-user.md): Adds a new EVM EOA account to an existing end user. End users can have up to 10 EVM accounts.
This API is intended to be used by the developer's own backend, and is authenticated using the developer's CDP API key.
- [Add an EVM smart account to an end user](https://docs.cdp.coinbase.com/api-reference/v2/rest-api/end-user-accounts/add-an-evm-smart-account-to-an-end-user.md): Creates an EVM smart account for an existing end user. The backend will create a new EVM EOA account to serve as the owner of the smart account.
This API is intended to be used by the developer's own backend, and is authenticated using the developer's CDP API key.
- [Create an end user](https://docs.cdp.coinbase.com/api-reference/v2/rest-api/end-user-accounts/create-an-end-user.md): Creates an end user. An end user is an entity that can own CDP EVM accounts, EVM smart accounts, and/or Solana accounts. 1 or more authentication methods must be associated with an end user. By default, no accounts are created unless the optional `evmAccount` and/or `solanaAccount` fields are provided.
This API is intended to be used by the developer's own backend, and is authenticated using the developer's CDP API key.
- [End User Accounts](https://docs.cdp.coinbase.com/api-reference/v2/rest-api/end-user-accounts/end-user-accounts.md)
- [Get an end user](https://docs.cdp.coinbase.com/api-reference/v2/rest-api/end-user-accounts/get-an-end-user.md): Gets an end user by ID.

This API is intended to be used by the developer's own backend, and is authenticated using the developer's CDP API key.
- [Import a private key for an end user](https://docs.cdp.coinbase.com/api-reference/v2/rest-api/end-user-accounts/import-a-private-key-for-an-end-user.md): Imports an existing private key for an end user into the developer's CDP Project. The private key must be encrypted using the CDP SDK's encryption scheme before being sent to this endpoint. This API should be called from the [CDP SDK](https://github.com/coinbase/cdp-sdk) to ensure that the associated private key is properly encrypted.
...
- [List end users](https://docs.cdp.coinbase.com/api-reference/v2/rest-api/end-user-accounts/list-end-users.md): Lists the end users belonging to the developer's CDP Project.
...
- [Prepare and send a user operation for EVM Smart Account](https://docs.cdp.coinbase.com/api-reference/v2/rest-api/evm-smart-accounts/prepare-and-send-a-user-operation-for-evm-smart-account.md): Prepares, signs, and sends a user operation for an EVM Smart Account. This API can be used only if the owner on Smart Account is a CDP EVM Account.
...
- [null](https://docs.cdp.coinbase.com/api-reference/v2/rest-api/payments/create-a-transfer-quote.md)
- [null](https://docs.cdp.coinbase.com/api-reference/v2/rest-api/payments/execute-a-transfer-quote.md)
- [null](https://docs.cdp.coinbase.com/api-reference/v2/rest-api/payments/get-a-transfer-by-id.md)
- [null](https://docs.cdp.coinbase.com/api-reference/v2/rest-api/payments/get-the-crypto-rails.md)
- [null](https://docs.cdp.coinbase.com/api-reference/v2/rest-api/payments/get-the-fiat-payment-methods.md)
...
- [Create webhook subscription](https://docs.cdp.coinbase.com/api-reference/v2/rest-api/webhooks/create-webhook-subscription.md): Subscribe to real-time events across CDP products using flexible filtering.
...
- [Delete webhook subscription](https://docs.cdp.coinbase.com/api-reference/v2/rest-api/webhooks/delete-webhook-subscription.md): Permanently delete a webhook subscription and stop all event deliveries.
This action cannot be undone.
...
- [Get webhook subscription details](https://docs.cdp.coinbase.com/api-reference/v2/rest-api/webhooks/get-webhook-subscription-details.md): Retrieve detailed information about a specific webhook subscription including
configuration, status, creation timestamp, and webhook signature secret.
...
- [List webhook subscriptions](https://docs.cdp.coinbase.com/api-reference/v2/rest-api/webhooks/list-webhook-subscriptions.md): Retrieve a paginated list of webhook subscriptions for the authenticated project.
Returns subscriptions for all CDP product events (onchain, onramp/offramp, wallet, etc.)
in descending order by creation time.
...
- [Update webhook subscription](https://docs.cdp.coinbase.com/api-reference/v2/rest-api/webhooks/update-webhook-subscription.md): Update an existing webhook subscription's configuration including
event types, target URL, filtering criteria, and enabled status.
All required fields must be provided, even if they are not being changed.
...
- [Coinbase App OAuth2 Permissions](https://docs.cdp.coinbase.com/coinbase-app/oauth2-integration/oauth2-permissions.md)
...
- [API Reference](https://docs.cdp.coinbase.com/coinbase-business/payment-link-apis/api-reference.md)
- [API & Schema Mapping](https://docs.cdp.coinbase.com/coinbase-business/payment-link-apis/migrate/api-schema-mapping.md)
- [FAQ & Resources](https://docs.cdp.coinbase.com/coinbase-business/payment-link-apis/migrate/faq.md)
- [Migrate from Commerce Overview](https://docs.cdp.coinbase.com/coinbase-business/payment-link-apis/migrate/overview.md)
- [Welcome to Payment Link APIs](https://docs.cdp.coinbase.com/coinbase-business/payment-link-apis/overview.md)
- [Test with Postman](https://docs.cdp.coinbase.com/coinbase-business/payment-link-apis/postman-files.md)
- [Sandbox Environment](https://docs.cdp.coinbase.com/coinbase-business/payment-link-apis/sandbox.md): Test your Payment Links API integration safely using the sandbox environment
- [Webhooks](https://docs.cdp.coinbase.com/coinbase-business/payment-link-apis/webhooks.md)
...
- [Welcome to Address History](https://docs.cdp.coinbase.com/data/address-history/overview.md)
- [Onchain Data FAQ](https://docs.cdp.coinbase.com/data/get-started/faq.md)
- [Welcome to Onchain Data](https://docs.cdp.coinbase.com/data/get-started/overview.md)
...
- [Welcome to Node](https://docs.cdp.coinbase.com/data/node/overview.md)
...
- [Join CDP Discord](https://docs.cdp.coinbase.com/data/node/support/join-cdp-discord.md)
- [REST API Reference](https://docs.cdp.coinbase.com/data/rest-api.md)
...
- [Welcome to Onchain Webhooks](https://docs.cdp.coinbase.com/data/webhooks/overview.md)
- [Webhooks Quickstart](https://docs.cdp.coinbase.com/data/webhooks/quickstart.md)
- [Upgrading to Webhooks v2](https://docs.cdp.coinbase.com/data/webhooks/v2-upgrade.md)
- [Verify Signatures](https://docs.cdp.coinbase.com/data/webhooks/verify-signatures.md)
...
- [Embedded Wallet: Account Management in Portal](https://docs.cdp.coinbase.com/embedded-wallets/account-manager.md)
- [Auth Method Linking](https://docs.cdp.coinbase.com/embedded-wallets/auth-method-linking.md)
- [Authentication Methods](https://docs.cdp.coinbase.com/embedded-wallets/authentication-methods.md)
- [Best Practices](https://docs.cdp.coinbase.com/embedded-wallets/best-practices.md)
- [Embedded Wallet: Custom Authentication](https://docs.cdp.coinbase.com/embedded-wallets/custom-authentication.md)
...
- [Gelato Integration](https://docs.cdp.coinbase.com/embedded-wallets/evm-features/gelato-integration.md)
- [Smart Accounts](https://docs.cdp.coinbase.com/embedded-wallets/evm-features/smart-accounts.md)
- [Spend Permissions](https://docs.cdp.coinbase.com/embedded-wallets/evm-features/spend-permissions.md)
- [Wagmi Integration](https://docs.cdp.coinbase.com/embedded-wallets/evm-features/wagmi.md)
- [FAQ](https://docs.cdp.coinbase.com/embedded-wallets/faq.md)
- [Implementation Guide](https://docs.cdp.coinbase.com/embedded-wallets/implementation-guide.md)
- [Embedded Wallet: MFA Enrollment](https://docs.cdp.coinbase.com/embedded-wallets/mfa/enrollment.md)
- [Embedded Wallet: Multi-Factor Authentication (MFA)](https://docs.cdp.coinbase.com/embedded-wallets/mfa/overview.md)
- [Customizing MFA Triggers](https://docs.cdp.coinbase.com/embedded-wallets/mfa/protected-operations.md)
- [Embedded Wallet: Handling MFA Prompts](https://docs.cdp.coinbase.com/embedded-wallets/mfa/verification.md)
- [Multiple Accounts](https://docs.cdp.coinbase.com/embedded-wallets/multiple-accounts.md)
...
- [React Native Quickstart](https://docs.cdp.coinbase.com/embedded-wallets/react-native/quickstart.md)
- [Security & Export](https://docs.cdp.coinbase.com/embedded-wallets/security-export.md)
- [Session Management](https://docs.cdp.coinbase.com/embedded-wallets/session-management.md)
- [Sending Transactions](https://docs.cdp.coinbase.com/embedded-wallets/solana-features/sending-transactions.md)
- [Signing](https://docs.cdp.coinbase.com/embedded-wallets/solana-features/signing.md)
- [Wallet Standard Integration](https://docs.cdp.coinbase.com/embedded-wallets/solana-features/wallet-standard.md)
...
- [USDC Send Hooks](https://docs.cdp.coinbase.com/embedded-wallets/usdc-send-hooks.md)
- [Embedded Wallet Pre-Generation](https://docs.cdp.coinbase.com/embedded-wallets/wallet-pre-generation.md)
- [Welcome to Embedded Wallets](https://docs.cdp.coinbase.com/embedded-wallets/welcome.md)
- [x402 Payment Protocol](https://docs.cdp.coinbase.com/embedded-wallets/x402-payments.md)
...
- [Onramp mobile and web demo apps](https://docs.cdp.coinbase.com/get-started/demo-apps/starter/onramp-demo-app.md)
...
- [Security Requirements](https://docs.cdp.coinbase.com/onramp-&-offramp/security-requirements.md)
...
- [Example Workflows](https://docs.cdp.coinbase.com/payments-mcp/examples.md)
- [FAQ](https://docs.cdp.coinbase.com/payments-mcp/faq.md)
- [Quickstart](https://docs.cdp.coinbase.com/payments-mcp/quickstart.md)
- [MCP Tools Reference](https://docs.cdp.coinbase.com/payments-mcp/tools-reference.md)
- [Welcome to Payments MCP](https://docs.cdp.coinbase.com/payments-mcp/welcome.md)
...
- [Prime FIX Market Data Messages](https://docs.cdp.coinbase.com/prime/fix-api/market-data.md)
...
- [APIError](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Classes/APIError.md)
- [AuthManager](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Classes/AuthManager.md)
- [CustomAuthError](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Classes/CustomAuthError.md)
- [EIP1193ProviderError](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Classes/EIP1193ProviderError.md)
- [InputValidationError](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Classes/InputValidationError.md)
- [InternalError](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Classes/InternalError.md)
- [MfaError](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Classes/MfaError.md)
- [ModuleResolutionError](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Classes/ModuleResolutionError.md)
- [ValidationError](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Classes/ValidationError.md)
- [authenticateWithJWT](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Functions/authenticateWithJWT.md)
- [buildKeyExportIframeUrl](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Functions/buildKeyExportIframeUrl.md)
- [calculateSecureIframeHeight](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Functions/calculateSecureIframeHeight.md)
- [cancelMfaVerification](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Functions/cancelMfaVerification.md)
- [createCDPEmbeddedWallet](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Functions/createCDPEmbeddedWallet.md)
- [createEvmEoaAccount](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Functions/createEvmEoaAccount.md)
- [createEvmKeyExportIframe](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Functions/createEvmKeyExportIframe.md)
- [createEvmSmartAccount](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Functions/createEvmSmartAccount.md)
- [createIframe](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Functions/createIframe.md)
- [createSolanaAccount](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Functions/createSolanaAccount.md)
- [createSolanaKeyExportIframe](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Functions/createSolanaKeyExportIframe.md)
- [createSpendPermission](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Functions/createSpendPermission.md)
- [exportEvmAccount](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Functions/exportEvmAccount.md)
- [exportSolanaAccount](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Functions/exportSolanaAccount.md)
- [fetchWithX402](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Functions/fetchWithX402.md)
- [getAccessToken](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Functions/getAccessToken.md)
- [getAccessTokenExpiration](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Functions/getAccessTokenExpiration.md)
- [getCurrentUser](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Functions/getCurrentUser.md)
- [getCurrentUserSync](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Functions/getCurrentUserSync.md)
- [getEnrolledMfaMethods](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Functions/getEnrolledMfaMethods.md)
- [getMfaConfig](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Functions/getMfaConfig.md)
- [getSecureIframeOrigin](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Functions/getSecureIframeOrigin.md)
- [getUserOperation](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Functions/getUserOperation.md)
- [initialize](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Functions/initialize.md)
- [initiateMfaEnrollment](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Functions/initiateMfaEnrollment.md)
- [initiateMfaVerification](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Functions/initiateMfaVerification.md)
- [isEnrolledInMfa](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Functions/isEnrolledInMfa.md)
- [isMfaProtectedAction](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Functions/isMfaProtectedAction.md)
- [isMfaRequired](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Functions/isMfaRequired.md)
- [isSecureIframeKeyExportMessage](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Functions/isSecureIframeKeyExportMessage.md)
- [isSignedIn](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Functions/isSignedIn.md)
- [linkApple](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Functions/linkApple.md)
- [linkEmail](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Functions/linkEmail.md)
- [linkGoogle](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Functions/linkGoogle.md)
- [linkOAuth](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Functions/linkOAuth.md)
- [linkSms](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Functions/linkSms.md)
- [listSpendPermissions](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Functions/listSpendPermissions.md)
- [onAuthStateChange](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Functions/onAuthStateChange.md)
- [onOAuthStateChange](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Functions/onOAuthStateChange.md)
- [recordMfaEnrollmentPrompted](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Functions/recordMfaEnrollmentPrompted.md)
- [registerMfaListener](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Functions/registerMfaListener.md)
- [revokeSpendPermission](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Functions/revokeSpendPermission.md)
- [sendEvmTransaction](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Functions/sendEvmTransaction.md)
- [sendSecureIframeMessage](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Functions/sendSecureIframeMessage.md)
- [sendSolanaTransaction](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Functions/sendSolanaTransaction.md)
- [sendUserOperation](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Functions/sendUserOperation.md)
- [signEvmHash](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Functions/signEvmHash.md)
- [signEvmMessage](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Functions/signEvmMessage.md)
- [signEvmTransaction](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Functions/signEvmTransaction.md)
- [signEvmTypedData](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Functions/signEvmTypedData.md)
- [signInWithEmail](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Functions/signInWithEmail.md)
- [signInWithOAuth](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Functions/signInWithOAuth.md)
- [signInWithSms](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Functions/signInWithSms.md)
- [signOut](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Functions/signOut.md)
- [signSolanaMessage](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Functions/signSolanaMessage.md)
- [signSolanaTransaction](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Functions/signSolanaTransaction.md)
- [submitMfaEnrollment](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Functions/submitMfaEnrollment.md)
- [submitMfaVerification](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Functions/submitMfaVerification.md)
- [toViemAccount](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Functions/toViemAccount.md)
- [validatePhoneNumber](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Functions/validatePhoneNumber.md)
- [validateSecureIframeEnvironment](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Functions/validateSecureIframeEnvironment.md)
- [verifyEmailOTP](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Functions/verifyEmailOTP.md)
- [verifyOAuth](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Functions/verifyOAuth.md)
- [verifySmsOTP](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Functions/verifySmsOTP.md)
- [AuthState](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Interfaces/AuthState.md)
- [BuildKeyExportIframeUrlOptions](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Interfaces/BuildKeyExportIframeUrlOptions.md)
- [CreateKeyExportIframeOptions](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Interfaces/CreateKeyExportIframeOptions.md)
- [CreateKeyExportIframeResult](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Interfaces/CreateKeyExportIframeResult.md)
- [EIP712Domain](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Interfaces/EIP712Domain.md)
- [EIP712TypedData](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Interfaces/EIP712TypedData.md)
- [EIP712Types](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Interfaces/EIP712Types.md)
- [EndUserEvmAccount](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Interfaces/EndUserEvmAccount.md)
- [EndUserEvmSmartAccount](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Interfaces/EndUserEvmSmartAccount.md)
- [EndUserSolanaAccount](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Interfaces/EndUserSolanaAccount.md)
- [IAuthManager](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Interfaces/IAuthManager.md)
- [IOAuthManager](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Interfaces/IOAuthManager.md)
- [MFAMethods](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Interfaces/MFAMethods.md)
- [OAuthFlowState](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Interfaces/OAuthFlowState.md)
- [WalletSecret](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Interfaces/WalletSecret.md)
- [APIErrorType](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/APIErrorType.md)
- [AccountsRequest](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/AccountsRequest.md)
- [AllowedEvmTransactionType](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/AllowedEvmTransactionType.md)
- [AuthenticateWithJWTResult](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/AuthenticateWithJWTResult.md)
- [AuthenticationMethods](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/AuthenticationMethods.md)
- [BaseConfig](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/BaseConfig.md)
- [CDPEmbeddedWallet](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/CDPEmbeddedWallet.md)
- [CDPEmbeddedWalletConfig](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/CDPEmbeddedWalletConfig.md)
- [ChainIdRequest](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/ChainIdRequest.md)
- [Config](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/Config.md)
- [CreateEvmSmartAccountOptions](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/CreateEvmSmartAccountOptions.md)
- [CreateSpendPermissionOptions](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/CreateSpendPermissionOptions.md)
- [CreateSpendPermissionResult](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/CreateSpendPermissionResult.md)
- [CustomAuth](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/CustomAuth.md)
- [EIP1193ErrorCode](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/EIP1193ErrorCode.md)
- [EIP1193Provider](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/EIP1193Provider.md)
- [EIP1193RequestFunctionType](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/EIP1193RequestFunctionType.md)
- [EIP712Message](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/EIP712Message.md)
- [EmailAuthentication](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/EmailAuthentication.md)
- [ErrorType](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/ErrorType.md)
- [EthSignRequest](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/EthSignRequest.md)
- [EthereumConfig](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/EthereumConfig.md)
- [EvmAddress](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/EvmAddress.md)
- [EvmCall](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/EvmCall.md)
- [ExactPartial](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/ExactPartial.md)
- [ExportEvmAccountOptions](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/ExportEvmAccountOptions.md)
- [ExportEvmAccountResult](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/ExportEvmAccountResult.md)
- [ExportSolanaAccountOptions](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/ExportSolanaAccountOptions.md)
- [ExportSolanaAccountResult](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/ExportSolanaAccountResult.md)
- [FetchWithX402Options](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/FetchWithX402Options.md)
- [FetchWithX402ReturnType](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/FetchWithX402ReturnType.md)
- [GetCallsStatusRequest](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/GetCallsStatusRequest.md)
- [GetCapabilitiesRequest](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/GetCapabilitiesRequest.md)
- [GetMfaConfigResult](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/GetMfaConfigResult.md)
- [GetUserOperationOptions](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/GetUserOperationOptions.md)
- [GetUserOperationResult](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/GetUserOperationResult.md)
- [Hex](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/Hex.md)
- [HttpErrorType](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/HttpErrorType.md)
- [InitiateMfaEnrollmentResult](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/InitiateMfaEnrollmentResult.md)
- [InitiateMfaOptions](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/InitiateMfaOptions.md)
- [InitiateMfaVerificationOptions](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/InitiateMfaVerificationOptions.md)
- [InitiateSmsMfaOptions](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/InitiateSmsMfaOptions.md)
- [InitiateSmsMfaResult](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/InitiateSmsMfaResult.md)
- [InitiateTotpMfaOptions](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/InitiateTotpMfaOptions.md)
- [InitiateTotpMfaResult](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/InitiateTotpMfaResult.md)
- [KeyPair](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/KeyPair.md)
- [ListSpendPermissionsOptions](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/ListSpendPermissionsOptions.md)
- [ListSpendPermissionsResult](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/ListSpendPermissionsResult.md)
- [MfaErrorCode](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/MfaErrorCode.md)
- [MfaListener](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/MfaListener.md)
- [MfaListenerOptions](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/MfaListenerOptions.md)
- [MfaMethod](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/MfaMethod.md)
- [MfaMethod](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/MfaMethod-1.md)
- [MfaProtectedAction](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/MfaProtectedAction.md)
- [MfaVerificationContext](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/MfaVerificationContext.md)
- [NetworkConfig](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/NetworkConfig.md)
- [OAuth2ProviderType](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/OAuth2ProviderType.md)
- [OAuthFlowStatus](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/OAuthFlowStatus.md)
- [OnAuthStateChangeFn](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/OnAuthStateChangeFn.md)
- [OnOAuthStateChangeFn](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/OnOAuthStateChangeFn.md)
- [PersonalSignMessage](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/PersonalSignMessage.md)
- [PersonalSignRequest](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/PersonalSignRequest.md)
- [ProviderRequest](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/ProviderRequest.md)
- [ProviderState](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/ProviderState.md)
- [ProviderStoreInstance](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/ProviderStoreInstance.md)
- [RPCErrorCode](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/RPCErrorCode.md)
- [RecordMfaEnrollmentPromptedResult](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/RecordMfaEnrollmentPromptedResult.md)
- [RequestAccountsRequest](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/RequestAccountsRequest.md)
- [RevokeSpendPermissionOptions](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/RevokeSpendPermissionOptions.md)
- [RevokeSpendPermissionResult](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/RevokeSpendPermissionResult.md)
- [SecureIframeAuthState](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/SecureIframeAuthState.md)
- [SecureIframeChainType](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/SecureIframeChainType.md)
- [SecureIframeContext](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/SecureIframeContext.md)
- [SecureIframeEventType](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/SecureIframeEventType.md)
- [SecureIframeGetPrivateKeyMessage](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/SecureIframeGetPrivateKeyMessage.md)
- [SecureIframeIncomingMessage](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/SecureIframeIncomingMessage.md)
- [SecureIframeInitMessage](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/SecureIframeInitMessage.md)
- [SecureIframeKeyExportEventType](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/SecureIframeKeyExportEventType.md)
- [SecureIframeKeyExportIncomingMessage](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/SecureIframeKeyExportIncomingMessage.md)
- [SecureIframeKeyExportOutgoingMessage](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/SecureIframeKeyExportOutgoingMessage.md)
- [SecureIframeListeningMessage](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/SecureIframeListeningMessage.md)
- [SecureIframeOutgoingMessage](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/SecureIframeOutgoingMessage.md)
- [SecureIframeStatus](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/SecureIframeStatus.md)
- [SecureIframeStatusMessage](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/SecureIframeStatusMessage.md)
- [SecureIframeTheme](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/SecureIframeTheme.md)
- [SecureIframeThemeMessage](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/SecureIframeThemeMessage.md)
- [SendCallsCapabilities](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/SendCallsCapabilities.md)
- [SendCallsRequest](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/SendCallsRequest.md)
- [SendEvmTransactionOptions](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/SendEvmTransactionOptions.md)
- [SendEvmTransactionResult](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/SendEvmTransactionResult.md)
- [SendEvmTransactionWithEndUserAccountBodyNetwork](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/SendEvmTransactionWithEndUserAccountBodyNetwork.md)
- [SendSolanaTransactionOptions](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/SendSolanaTransactionOptions.md)
- [SendSolanaTransactionResult](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/SendSolanaTransactionResult.md)
- [SendSolanaTransactionWithEndUserAccountBodyNetwork](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/SendSolanaTransactionWithEndUserAccountBodyNetwork.md)
- [SendTransactionRequest](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/SendTransactionRequest.md)
- [SendTransactionRequestParams](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/SendTransactionRequestParams.md)
- [SendUserOperationOptions](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/SendUserOperationOptions.md)
- [SendUserOperationResult](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/SendUserOperationResult.md)
- [SignEvmHashOptions](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/SignEvmHashOptions.md)
- [SignEvmHashResult](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/SignEvmHashResult.md)
- [SignEvmMessageOptions](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/SignEvmMessageOptions.md)
- [SignEvmMessageResult](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/SignEvmMessageResult.md)
- [SignEvmTransactionOptions](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/SignEvmTransactionOptions.md)
- [SignEvmTransactionResult](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/SignEvmTransactionResult.md)
- [SignEvmTypedDataOptions](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/SignEvmTypedDataOptions.md)
- [SignEvmTypedDataResult](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/SignEvmTypedDataResult.md)
- [SignInWithEmailOptions](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/SignInWithEmailOptions.md)
- [SignInWithEmailResult](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/SignInWithEmailResult.md)
- [SignInWithSmsOptions](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/SignInWithSmsOptions.md)
- [SignInWithSmsResult](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/SignInWithSmsResult.md)
- [SignSolanaMessageOptions](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/SignSolanaMessageOptions.md)
- [SignSolanaMessageResult](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/SignSolanaMessageResult.md)
- [SignSolanaTransactionOptions](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/SignSolanaTransactionOptions.md)
- [SignSolanaTransactionResult](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/SignSolanaTransactionResult.md)
- [SignTypedDataRequest](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/SignTypedDataRequest.md)
- [SmsAuthentication](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/SmsAuthentication.md)
- [SolanaAddress](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/SolanaAddress.md)
- [SpendPermission](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/SpendPermission.md)
- [SpendPermissionInput](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/SpendPermissionInput.md)
- [SpendPermissionNetwork](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/SpendPermissionNetwork.md)
- [SpendPermissionNetwork](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/SpendPermissionNetwork-1.md)
- [SubmitMfaEnrollmentOptions](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/SubmitMfaEnrollmentOptions.md)
- [SubmitMfaEnrollmentResult](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/SubmitMfaEnrollmentResult.md)
- [SubmitMfaVerificationOptions](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/SubmitMfaVerificationOptions.md)
- [SwitchEthereumChainRequest](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/SwitchEthereumChainRequest.md)
- [UnknownRequest](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/UnknownRequest.md)
- [User](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/User.md)
- [VerifyEmailOTPOptions](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/VerifyEmailOTPOptions.md)
- [VerifyEmailOTPResult](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/VerifyEmailOTPResult.md)
- [VerifyOAuthOptions](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/VerifyOAuthOptions.md)
- [VerifyOAuthResult](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/VerifyOAuthResult.md)
- [VerifySmsOTPOptions](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/VerifySmsOTPOptions.md)
- [VerifySmsOTPResult](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/VerifySmsOTPResult.md)
- [WalletCapabilities](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/WalletCapabilities.md)
- [WalletDisconnectRequest](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Type-Aliases/WalletDisconnectRequest.md)
- [DEFAULT_SECURE_IFRAME_BASE_PATH](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Variables/DEFAULT_SECURE_IFRAME_BASE_PATH.md)
- [DEFAULT_SECURE_IFRAME_THEME](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Variables/DEFAULT_SECURE_IFRAME_THEME.md)
- [ErrorType](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Variables/ErrorType.md)
- [HttpErrorType](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Variables/HttpErrorType.md)
- [MFA_PROTECTED_ACTIONS](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Variables/MFA_PROTECTED_ACTIONS.md)
- [MFA_PROTECTED_FUNCTIONS](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Variables/MFA_PROTECTED_FUNCTIONS.md)
- [OAuth2ProviderType](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Variables/OAuth2ProviderType.md)
- [SECURE_IFRAME_EVENT_TYPE](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Variables/SECURE_IFRAME_EVENT_TYPE.md)
- [SECURE_IFRAME_EVENT_TYPE_PREFIX](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Variables/SECURE_IFRAME_EVENT_TYPE_PREFIX.md)
- [SECURE_IFRAME_KEY_EXPORT_EVENT_TYPE](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Variables/SECURE_IFRAME_KEY_EXPORT_EVENT_TYPE.md)
- [STANDARD_ERROR_CODES](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Variables/STANDARD_ERROR_CODES.md)
- [SendEvmTransactionWithEndUserAccountBodyNetwork](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Variables/SendEvmTransactionWithEndUserAccountBodyNetwork.md)
- [SendSolanaTransactionWithEndUserAccountBodyNetwork](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/Variables/SendSolanaTransactionWithEndUserAccountBodyNetwork.md)
- [Overview](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/index.md)
- [Reference](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-core/reference.md)
- [APIError](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Classes/APIError.md)
- [CDPHooksProvider](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Functions/CDPHooksProvider.md)
- [useAuthenticateWithJWT](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Functions/useAuthenticateWithJWT.md)
- [useCancelMfaVerification](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Functions/useCancelMfaVerification.md)
- [useConfig](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Functions/useConfig.md)
- [useCreateEvmEoaAccount](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Functions/useCreateEvmEoaAccount.md)
- [useCreateEvmSmartAccount](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Functions/useCreateEvmSmartAccount.md)
- [useCreateSolanaAccount](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Functions/useCreateSolanaAccount.md)
- [useCreateSpendPermission](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Functions/useCreateSpendPermission.md)
- [useCurrentUser](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Functions/useCurrentUser.md)
- [useEnforceAuthenticated](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Functions/useEnforceAuthenticated.md)
- [useEnforceUnauthenticated](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Functions/useEnforceUnauthenticated.md)
- [useEvmAccounts](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Functions/useEvmAccounts.md)
- [useEvmAddress](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Functions/useEvmAddress.md)
- [useEvmKeyExportIframe](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Functions/useEvmKeyExportIframe.md)
- [useEvmSmartAccounts](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Functions/useEvmSmartAccounts.md)
- [useExportEvmAccount](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Functions/useExportEvmAccount.md)
- [useExportSolanaAccount](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Functions/useExportSolanaAccount.md)
- [useGetAccessToken](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Functions/useGetAccessToken.md)
- [useGetMfaConfig](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Functions/useGetMfaConfig.md)
- [useInitiateMfaEnrollment](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Functions/useInitiateMfaEnrollment.md)
- [useInitiateMfaVerification](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Functions/useInitiateMfaVerification.md)
- [useIsInitialized](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Functions/useIsInitialized.md)
- [useIsSignedIn](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Functions/useIsSignedIn.md)
- [useLinkApple](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Functions/useLinkApple.md)
- [useLinkEmail](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Functions/useLinkEmail.md)
- [useLinkGoogle](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Functions/useLinkGoogle.md)
- [useLinkOAuth](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Functions/useLinkOAuth.md)
- [useLinkSms](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Functions/useLinkSms.md)
- [useListSpendPermissions](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Functions/useListSpendPermissions.md)
- [useOAuthState](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Functions/useOAuthState.md)
- [useRecordMfaEnrollmentPrompted](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Functions/useRecordMfaEnrollmentPrompted.md)
- [useRegisterMfaListener](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Functions/useRegisterMfaListener.md)
- [useRevokeSpendPermission](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Functions/useRevokeSpendPermission.md)
- [useSendEvmTransaction](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Functions/useSendEvmTransaction.md)
- [useSendSolanaTransaction](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Functions/useSendSolanaTransaction.md)
- [useSendUserOperation](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Functions/useSendUserOperation.md)
- [useSignEvmHash](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Functions/useSignEvmHash.md)
- [useSignEvmMessage](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Functions/useSignEvmMessage.md)
- [useSignEvmTransaction](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Functions/useSignEvmTransaction.md)
- [useSignEvmTypedData](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Functions/useSignEvmTypedData.md)
- [useSignInWithEmail](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Functions/useSignInWithEmail.md)
- [useSignInWithOAuth](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Functions/useSignInWithOAuth.md)
- [useSignInWithSms](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Functions/useSignInWithSms.md)
- [useSignOut](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Functions/useSignOut.md)
- [useSignSolanaMessage](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Functions/useSignSolanaMessage.md)
- [useSignSolanaTransaction](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Functions/useSignSolanaTransaction.md)
- [useSolanaAccounts](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Functions/useSolanaAccounts.md)
- [useSolanaAddress](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Functions/useSolanaAddress.md)
- [useSolanaKeyExportIframe](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Functions/useSolanaKeyExportIframe.md)
- [useSubmitMfaEnrollment](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Functions/useSubmitMfaEnrollment.md)
- [useSubmitMfaVerification](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Functions/useSubmitMfaVerification.md)
- [useVerifyEmailOTP](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Functions/useVerifyEmailOTP.md)
- [useVerifySmsOTP](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Functions/useVerifySmsOTP.md)
- [useWaitForUserOperation](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Functions/useWaitForUserOperation.md)
- [useX402](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Functions/useX402.md)
- [CDPContextValue](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Interfaces/CDPContextValue.md)
- [CDPHooksProviderProps](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Interfaces/CDPHooksProviderProps.md)
- [EIP712TypedData](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Interfaces/EIP712TypedData.md)
- [OAuthFlowState](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Interfaces/OAuthFlowState.md)
- [UseKeyExportIframeOptions](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Interfaces/UseKeyExportIframeOptions.md)
- [UseKeyExportIframeResult](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Interfaces/UseKeyExportIframeResult.md)
- [UseRegisterMfaListenerOptions](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Interfaces/UseRegisterMfaListenerOptions.md)
- [APIErrorType](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Type-Aliases/APIErrorType.md)
- [AllowedEvmTransactionType](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Type-Aliases/AllowedEvmTransactionType.md)
- [Config](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Type-Aliases/Config.md)
- [CreateEvmSmartAccountOptions](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Type-Aliases/CreateEvmSmartAccountOptions.md)
- [CreateSpendPermissionOptions](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Type-Aliases/CreateSpendPermissionOptions.md)
- [EvmAddress](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Type-Aliases/EvmAddress.md)
- [ExportEvmAccountOptions](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Type-Aliases/ExportEvmAccountOptions.md)
- [ExportEvmAccountResult](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Type-Aliases/ExportEvmAccountResult.md)
- [ExportSolanaAccountOptions](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Type-Aliases/ExportSolanaAccountOptions.md)
- [ExportSolanaAccountResult](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Type-Aliases/ExportSolanaAccountResult.md)
- [GetUserOperationResult](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Type-Aliases/GetUserOperationResult.md)
- [Hex](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Type-Aliases/Hex.md)
- [MfaRequiredCallback](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Type-Aliases/MfaRequiredCallback.md)
- [OAuth2ProviderType](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Type-Aliases/OAuth2ProviderType.md)
- [RevokeSpendPermissionOptions](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Type-Aliases/RevokeSpendPermissionOptions.md)
- [SendEvmTransactionOptions](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Type-Aliases/SendEvmTransactionOptions.md)
- [SendEvmTransactionResult](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Type-Aliases/SendEvmTransactionResult.md)
- [SendSolanaTransactionOptions](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Type-Aliases/SendSolanaTransactionOptions.md)
- [SendSolanaTransactionResult](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Type-Aliases/SendSolanaTransactionResult.md)
- [SignEvmHashOptions](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Type-Aliases/SignEvmHashOptions.md)
- [SignEvmHashResult](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Type-Aliases/SignEvmHashResult.md)
- [SignEvmMessageOptions](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Type-Aliases/SignEvmMessageOptions.md)
- [SignEvmMessageResult](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Type-Aliases/SignEvmMessageResult.md)
- [SignEvmTransactionOptions](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Type-Aliases/SignEvmTransactionOptions.md)
- [SignEvmTransactionResult](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Type-Aliases/SignEvmTransactionResult.md)
- [SignEvmTypedDataOptions](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Type-Aliases/SignEvmTypedDataOptions.md)
- [SignEvmTypedDataResult](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Type-Aliases/SignEvmTypedDataResult.md)
- [SignInWithEmailOptions](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Type-Aliases/SignInWithEmailOptions.md)
- [SignInWithEmailResult](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Type-Aliases/SignInWithEmailResult.md)
- [SpendPermission](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Type-Aliases/SpendPermission.md)
- [SpendPermissionPage](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Type-Aliases/SpendPermissionPage.md)
- [Status](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Type-Aliases/Status.md)
- [TransactionState](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Type-Aliases/TransactionState.md)
- [UseCreateSpendPermissionReturnType](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Type-Aliases/UseCreateSpendPermissionReturnType.md)
- [UseListSpendPermissionsOptions](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Type-Aliases/UseListSpendPermissionsOptions.md)
- [UseListSpendPermissionsReturnType](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Type-Aliases/UseListSpendPermissionsReturnType.md)
- [UseRevokeSpendPermissionReturnType](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Type-Aliases/UseRevokeSpendPermissionReturnType.md)
- [UseSendUserOperationReturnType](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Type-Aliases/UseSendUserOperationReturnType.md)
- [UseWaitForUserOperationParameters](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Type-Aliases/UseWaitForUserOperationParameters.md)
- [UseWaitForUserOperationReturnType](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Type-Aliases/UseWaitForUserOperationReturnType.md)
- [User](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Type-Aliases/User.md)
- [VerifyEmailOTPOptions](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Type-Aliases/VerifyEmailOTPOptions.md)
- [VerifyEmailOTPResult](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Type-Aliases/VerifyEmailOTPResult.md)
- [CDPContext](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Variables/CDPContext.md)
- [OAuth2ProviderType](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/Variables/OAuth2ProviderType.md)
- [Overview](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/index.md)
- [Reference](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-hooks/reference.md)
- [AuthButton](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Components/AuthButton.md)
- [Button](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Components/Button.md)
- [CDPReactProvider](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Components/CDPReactProvider.md)
- [CopyAddress](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Components/CopyAddress.md)
- [CopyEvmKeyButton](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Components/CopyEvmKeyButton.md)
- [CopySolanaKeyButton](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Components/CopySolanaKeyButton.md)
- [EnrollMfa](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Components/EnrollMfa.md)
- [EnrollMfa Overview](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Components/EnrollMfa.README.md)
- [EnrollMfaDescription](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Components/EnrollMfaDescription.md)
- [EnrollMfaError](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Components/EnrollMfaError.md)
- [EnrollMfaFlow](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Components/EnrollMfaFlow.md)
- [EnrollMfaFlowBackButton](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Components/EnrollMfaFlowBackButton.md)
- [EnrollMfaFooter](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Components/EnrollMfaFooter.md)
- [EnrollMfaImage](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Components/EnrollMfaImage.md)
- [EnrollMfaItem](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Components/EnrollMfaItem.md)
- [EnrollMfaItems](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Components/EnrollMfaItems.md)
- [EnrollMfaModal](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Components/EnrollMfaModal.md)
- [EnrollMfaModalContent](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Components/EnrollMfaModalContent.md)
- [EnrollMfaModalTrigger](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Components/EnrollMfaModalTrigger.md)
- [EnrollMfaTitle](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Components/EnrollMfaTitle.md)
- [ExportWallet](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Components/ExportWallet.md)
- [ExportWallet Overview](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Components/ExportWallet.README.md)
- [ExportWalletCopyAddress](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Components/ExportWalletCopyAddress.md)
- [ExportWalletCopyKeyButton](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Components/ExportWalletCopyKeyButton.md)
- [ExportWalletFooter](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Components/ExportWalletFooter.md)
- [ExportWalletModal](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Components/ExportWalletModal.md)
- [ExportWalletModalClose](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Components/ExportWalletModalClose.md)
- [ExportWalletModalContent](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Components/ExportWalletModalContent.md)
- [ExportWalletModalTitle](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Components/ExportWalletModalTitle.md)
- [ExportWalletModalTrigger](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Components/ExportWalletModalTrigger.md)
- [ExportWalletTitle](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Components/ExportWalletTitle.md)
- [ExportWalletWarning](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Components/ExportWalletWarning.md)
- [Fund](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Components/Fund.md)
- [Fund Overview](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Components/Fund.README.md)
- [FundFooter](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Components/FundFooter.md)
- [FundForm](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Components/FundForm.md)
- [FundModal](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Components/FundModal.md)
- [FundModalContent](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Components/FundModalContent.md)
- [FundModalTrigger](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Components/FundModalTrigger.md)
- [FundTitle](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Components/FundTitle.md)
- [IconAppleLogo](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Components/IconAppleLogo.md)
- [IconArrowLeft](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Components/IconArrowLeft.md)
- [IconArrowsUpDown](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Components/IconArrowsUpDown.md)
- [IconCheck](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Components/IconCheck.md)
- [IconCheckCircle](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Components/IconCheckCircle.md)
- [IconChevronDown](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Components/IconChevronDown.md)
- [IconCopy](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Components/IconCopy.md)
- [IconEnvelope](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Components/IconEnvelope.md)
- [IconExclamationCircle](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Components/IconExclamationCircle.md)
- [IconExclamationTriangle](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Components/IconExclamationTriangle.md)
- [IconGoogleLogo](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Components/IconGoogleLogo.md)
- [IconLock](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Components/IconLock.md)
- [IconMinus](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Components/IconMinus.md)
- [IconPhone](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Components/IconPhone.md)
- [IconPinCode](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Components/IconPinCode.md)
- [IconPlus](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Components/IconPlus.md)
- [IconShield](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Components/IconShield.md)
- [IconSmartPhone](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Components/IconSmartPhone.md)
- [IconXMark](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Components/IconXMark.md)
- [LinkAuth](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Components/LinkAuth.md)
- [LinkAuth Overview](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Components/LinkAuth.README.md)
- [LinkAuthError](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Components/LinkAuthError.md)
- [LinkAuthFlow](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Components/LinkAuthFlow.md)
- [LinkAuthFlowBackButton](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Components/LinkAuthFlowBackButton.md)
- [LinkAuthItem](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Components/LinkAuthItem.md)
- [LinkAuthItems](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Components/LinkAuthItems.md)
- [LinkAuthModal](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Components/LinkAuthModal.md)
- [LinkAuthModalContent](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Components/LinkAuthModalContent.md)
- [LinkAuthModalTrigger](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Components/LinkAuthModalTrigger.md)
- [LinkAuthTitle](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Components/LinkAuthTitle.md)
- [Modal](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Components/Modal.md)
- [ModalClose](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Components/ModalClose.md)
- [ModalContent](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Components/ModalContent.md)
- [ModalDescription](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Components/ModalDescription.md)
- [ModalTitle](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Components/ModalTitle.md)
- [ModalTrigger](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Components/ModalTrigger.md)
- [SendEvmTransactionButton](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Components/SendEvmTransactionButton.md)
- [SendSolanaTransactionButton](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Components/SendSolanaTransactionButton.md)
- [SignIn](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Components/SignIn.md)
- [SignIn Overview](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Components/SignIn.README.md)
- [SignInAuthMethodButtons](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Components/SignInAuthMethodButtons.md)
- [SignInBackButton](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Components/SignInBackButton.md)
- [SignInDescription](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Components/SignInDescription.md)
- [SignInFooter](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Components/SignInFooter.md)
- [SignInForm](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Components/SignInForm.md)
- [SignInImage](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Components/SignInImage.md)
- [SignInModal](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Components/SignInModal.md)
- [SignInModalContent](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Components/SignInModalContent.md)
- [SignInModalTrigger](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Components/SignInModalTrigger.md)
- [SignInTitle](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Components/SignInTitle.md)
- [SignOutButton](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Components/SignOutButton.md)
- [ThemeProvider](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Components/ThemeProvider.md)
- [VerifyMfa](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Components/VerifyMfa.md)
- [VerifyMfa Overview](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Components/VerifyMfa.README.md)
- [VerifyMfaDescription](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Components/VerifyMfaDescription.md)
- [VerifyMfaFlow](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Components/VerifyMfaFlow.md)
- [VerifyMfaFooter](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Components/VerifyMfaFooter.md)
- [VerifyMfaImage](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Components/VerifyMfaImage.md)
- [VerifyMfaInline](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Components/VerifyMfaInline.md)
- [VerifyMfaInline Overview](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Components/VerifyMfaInline.README.md)
- [VerifyMfaInlineBackButton](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Components/VerifyMfaInlineBackButton.md)
- [VerifyMfaInlineFlow](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Components/VerifyMfaInlineFlow.md)
- [VerifyMfaModal](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Components/VerifyMfaModal.md)
- [VerifyMfaModalContent](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Components/VerifyMfaModalContent.md)
- [VerifyMfaModalTrigger](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Components/VerifyMfaModalTrigger.md)
- [VerifyMfaTitle](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Components/VerifyMfaTitle.md)
- [useAppConfig](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Hooks/useAppConfig.md)
- [useEnrollMfaContext](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Hooks/useEnrollMfaContext.md)
- [useEnrollMfaFlow](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Hooks/useEnrollMfaFlow.md)
- [useFundContext](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Hooks/useFundContext.md)
- [useLinkAuthContext](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Hooks/useLinkAuthContext.md)
- [useLinkAuthFlow](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Hooks/useLinkAuthFlow.md)
- [useProviderName](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Hooks/useProviderName.md)
- [useSignInContext](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Hooks/useSignInContext.md)
- [useSignInReducer](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Hooks/useSignInReducer.md)
- [useTheme](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Hooks/useTheme.md)
- [useVerifyMfaContext](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Hooks/useVerifyMfaContext.md)
- [useVerifyMfaInlineContext](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Hooks/useVerifyMfaInlineContext.md)
- [useVerifyMfaModal](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Hooks/useVerifyMfaModal.md)
- [AppConfig](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Interfaces/AppConfig.md)
- [AuthButtonProps](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Interfaces/AuthButtonProps.md)
- [ButtonProps](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Interfaces/ButtonProps.md)
- [CDPReactProviderProps](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Interfaces/CDPReactProviderProps.md)
- [CopyAddressProps](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Interfaces/CopyAddressProps.md)
- [CopyEvmKeyButtonProps](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Interfaces/CopyEvmKeyButtonProps.md)
- [CopySolanaKeyButtonProps](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Interfaces/CopySolanaKeyButtonProps.md)
- [EnrollMfaContextValue](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Interfaces/EnrollMfaContextValue.md)
- [EnrollMfaDescriptionProps](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Interfaces/EnrollMfaDescriptionProps.md)
- [EnrollMfaFlowBackButtonProps](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Interfaces/EnrollMfaFlowBackButtonProps.md)
- [EnrollMfaFlowContextValue](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Interfaces/EnrollMfaFlowContextValue.md)
- [EnrollMfaFlowProps](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Interfaces/EnrollMfaFlowProps.md)
- [EnrollMfaImageProps](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Interfaces/EnrollMfaImageProps.md)
- [EnrollMfaItemProps](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Interfaces/EnrollMfaItemProps.md)
- [EnrollMfaItemsProps](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Interfaces/EnrollMfaItemsProps.md)
- [EnrollMfaModalContentProps](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Interfaces/EnrollMfaModalContentProps.md)
- [EnrollMfaModalProps](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Interfaces/EnrollMfaModalProps.md)
- [EnrollMfaModalTriggerProps](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Interfaces/EnrollMfaModalTriggerProps.md)
- [EnrollMfaProps](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Interfaces/EnrollMfaProps.md)
- [EnrollMfaState](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Interfaces/EnrollMfaState.md)
- [EnrollMfaTitleProps](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Interfaces/EnrollMfaTitleProps.md)
- [ExportWalletModalCloseProps](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Interfaces/ExportWalletModalCloseProps.md)
- [ExportWalletModalProps](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Interfaces/ExportWalletModalProps.md)
- [ExportWalletModalTriggerProps](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Interfaces/ExportWalletModalTriggerProps.md)
- [ExportWalletProps](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Interfaces/ExportWalletProps.md)
- [ExportWalletTitleProps](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Interfaces/ExportWalletTitleProps.md)
- [FetchBuyUrlParams](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Interfaces/FetchBuyUrlParams.md)
- [FundFormProps](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Interfaces/FundFormProps.md)
- [FundModalContentProps](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Interfaces/FundModalContentProps.md)
- [FundModalProps](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Interfaces/FundModalProps.md)
- [FundModalTriggerProps](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Interfaces/FundModalTriggerProps.md)
- [FundPaymentMethod](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Interfaces/FundPaymentMethod.md)
- [FundProps](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Interfaces/FundProps.md)
- [FundState](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Interfaces/FundState.md)
- [FundTitleProps](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Interfaces/FundTitleProps.md)
- [LinkAuthContextValue](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Interfaces/LinkAuthContextValue.md)
- [LinkAuthFlowBackButtonProps](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Interfaces/LinkAuthFlowBackButtonProps.md)
- [LinkAuthFlowContextValue](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Interfaces/LinkAuthFlowContextValue.md)
- [LinkAuthFlowProps](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Interfaces/LinkAuthFlowProps.md)
- [LinkAuthItemProps](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Interfaces/LinkAuthItemProps.md)
- [LinkAuthItemsProps](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Interfaces/LinkAuthItemsProps.md)
- [LinkAuthModalContentProps](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Interfaces/LinkAuthModalContentProps.md)
- [LinkAuthModalProps](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Interfaces/LinkAuthModalProps.md)
- [LinkAuthModalTriggerProps](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Interfaces/LinkAuthModalTriggerProps.md)
- [LinkAuthProps](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Interfaces/LinkAuthProps.md)
- [LinkAuthState](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Interfaces/LinkAuthState.md)
- [LinkAuthTitleProps](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Interfaces/LinkAuthTitleProps.md)
- [ModalContentProps](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Interfaces/ModalContentProps.md)
- [OnrampError](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Interfaces/OnrampError.md)
- [PhoneNumber](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Interfaces/PhoneNumber.md)
- [SendEvmTransactionButtonProps](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Interfaces/SendEvmTransactionButtonProps.md)
- [SendSolanaTransactionButtonProps](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Interfaces/SendSolanaTransactionButtonProps.md)
- [SignInAuthMethodButtonsProps](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Interfaces/SignInAuthMethodButtonsProps.md)
- [SignInBackButtonProps](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Interfaces/SignInBackButtonProps.md)
- [SignInDescriptionProps](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Interfaces/SignInDescriptionProps.md)
- [SignInFormProps](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Interfaces/SignInFormProps.md)
- [SignInImageProps](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Interfaces/SignInImageProps.md)
- [SignInModalContentProps](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Interfaces/SignInModalContentProps.md)
- [SignInModalProps](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Interfaces/SignInModalProps.md)
- [SignInModalTriggerProps](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Interfaces/SignInModalTriggerProps.md)
- [SignInProps](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Interfaces/SignInProps.md)
- [SignInState](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Interfaces/SignInState.md)
- [SignInTitleProps](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Interfaces/SignInTitleProps.md)
- [SignOutButtonProps](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Interfaces/SignOutButtonProps.md)
- [ThemeContextValue](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Interfaces/ThemeContextValue.md)
- [UseVerifyMfaModalOptions](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Interfaces/UseVerifyMfaModalOptions.md)
- [UseVerifyMfaModalReturn](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Interfaces/UseVerifyMfaModalReturn.md)
- [VerifyMfaContextValue](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Interfaces/VerifyMfaContextValue.md)
- [VerifyMfaDescriptionProps](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Interfaces/VerifyMfaDescriptionProps.md)
- [VerifyMfaFlowProps](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Interfaces/VerifyMfaFlowProps.md)
- [VerifyMfaImageProps](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Interfaces/VerifyMfaImageProps.md)
- [VerifyMfaInlineBackButtonProps](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Interfaces/VerifyMfaInlineBackButtonProps.md)
- [VerifyMfaInlineContextValue](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Interfaces/VerifyMfaInlineContextValue.md)
- [VerifyMfaInlineFlowProps](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Interfaces/VerifyMfaInlineFlowProps.md)
- [VerifyMfaInlineProps](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Interfaces/VerifyMfaInlineProps.md)
- [VerifyMfaModalContentProps](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Interfaces/VerifyMfaModalContentProps.md)
- [VerifyMfaModalProps](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Interfaces/VerifyMfaModalProps.md)
- [VerifyMfaModalTriggerProps](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Interfaces/VerifyMfaModalTriggerProps.md)
- [VerifyMfaProps](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Interfaces/VerifyMfaProps.md)
- [VerifyMfaState](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Interfaces/VerifyMfaState.md)
- [VerifyMfaTitleProps](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Interfaces/VerifyMfaTitleProps.md)
- [AuthButtonSlots](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Type-Aliases/AuthButtonSlots.md)
- [AuthMethod](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Type-Aliases/AuthMethod.md)
- [BorderRadiusTokens](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Type-Aliases/BorderRadiusTokens.md)
- [ButtonSize](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Type-Aliases/ButtonSize.md)
- [ButtonVariant](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Type-Aliases/ButtonVariant.md)
- [CDPWebCSSVariables](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Type-Aliases/CDPWebCSSVariables.md)
- [CamelToSnakeCase](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Type-Aliases/CamelToSnakeCase.md)
- [CamelToSnakeCaseNested](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Type-Aliases/CamelToSnakeCaseNested.md)
- [ColorTokens](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Type-Aliases/ColorTokens.md)
- [ComponentBorderRadius](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Type-Aliases/ComponentBorderRadius.md)
- [ComponentColors](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Type-Aliases/ComponentColors.md)
- [ComponentFonts](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Type-Aliases/ComponentFonts.md)
- [Config](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Type-Aliases/Config.md)
- [EnrollMfaAction](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Type-Aliases/EnrollMfaAction.md)
- [EnrollMfaStep](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Type-Aliases/EnrollMfaStep.md)
- [ExportWalletCopyAddressProps](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Type-Aliases/ExportWalletCopyAddressProps.md)
- [ExportWalletCopyKeyButtonProps](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Type-Aliases/ExportWalletCopyKeyButtonProps.md)
- [ExportWalletModalContentProps](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Type-Aliases/ExportWalletModalContentProps.md)
- [ExportWalletModalTitleProps](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Type-Aliases/ExportWalletModalTitleProps.md)
- [FetchBuyOptions](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Type-Aliases/FetchBuyOptions.md)
- [FetchBuyQuote](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Type-Aliases/FetchBuyQuote.md)
- [Flattened](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Type-Aliases/Flattened.md)
- [FontTokens](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Type-Aliases/FontTokens.md)
- [FundAction](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Type-Aliases/FundAction.md)
- [FundContextType](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Type-Aliases/FundContextType.md)
- [FundLifecycleStatus](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Type-Aliases/FundLifecycleStatus.md)
- [FundPresetAmountInputs](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Type-Aliases/FundPresetAmountInputs.md)
- [FundStateError](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Type-Aliases/FundStateError.md)
- [FundStateProps](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Type-Aliases/FundStateProps.md)
- [IframeTheme](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Type-Aliases/IframeTheme.md)
- [InputSize](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Type-Aliases/InputSize.md)
- [InputType](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Type-Aliases/InputType.md)
- [KebabCasePaths](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Type-Aliases/KebabCasePaths.md)
- [LinkAuthAction](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Type-Aliases/LinkAuthAction.md)
- [LinkAuthMethod](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Type-Aliases/LinkAuthMethod.md)
- [MfaMethod](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Type-Aliases/MfaMethod.md)
- [NestedTokenObject](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Type-Aliases/NestedTokenObject.md)
- [OnrampAmount](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Type-Aliases/OnrampAmount.md)
- [OnrampBuyOptionsResponse](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Type-Aliases/OnrampBuyOptionsResponse.md)
- [OnrampBuyOptionsSnakeCaseResponse](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Type-Aliases/OnrampBuyOptionsSnakeCaseResponse.md)
- [OnrampBuyQuoteResponse](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Type-Aliases/OnrampBuyQuoteResponse.md)
- [OnrampBuyQuoteSnakeCaseResponse](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Type-Aliases/OnrampBuyQuoteSnakeCaseResponse.md)
- [OnrampNetwork](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Type-Aliases/OnrampNetwork.md)
- [OnrampPaymentCurrency](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Type-Aliases/OnrampPaymentCurrency.md)
- [OnrampPaymentMethodLimit](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Type-Aliases/OnrampPaymentMethodLimit.md)
- [OnrampPurchaseCurrency](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Type-Aliases/OnrampPurchaseCurrency.md)
- [OnrampSuccessEventData](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Type-Aliases/OnrampSuccessEventData.md)
- [SemanticBorderRadius](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Type-Aliases/SemanticBorderRadius.md)
- [SemanticColors](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Type-Aliases/SemanticColors.md)
- [SemanticFonts](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Type-Aliases/SemanticFonts.md)
- [SignInAction](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Type-Aliases/SignInAction.md)
- [Size](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Type-Aliases/Size.md)
- [Theme](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Type-Aliases/Theme.md)
- [ThemeProviderProps](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Type-Aliases/ThemeProviderProps.md)
- [TokenValue](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Type-Aliases/TokenValue.md)
- [Tokens](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Type-Aliases/Tokens.md)
- [VerifyMfaAction](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Type-Aliases/VerifyMfaAction.md)
- [VerifyMfaInlineDirection](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Type-Aliases/VerifyMfaInlineDirection.md)
- [VerifyMfaInlineView](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Type-Aliases/VerifyMfaInlineView.md)
- [clamp](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Utilities/clamp.md)
- [flattenTokensObject](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Utilities/flattenTokensObject.md)
- [getMessageFromUnknownError](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Utilities/getMessageFromUnknownError.md)
- [isApiError](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Utilities/isApiError.md)
- [isEmailInvalid](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Utilities/isEmailInvalid.md)
- [parseValuesFromPhoneNumber](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Utilities/parseValuesFromPhoneNumber.md)
- [sendIframeMessage](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Utilities/sendIframeMessage.md)
- [themeToCssVariables](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Utilities/themeToCssVariables.md)
- [ALL_AUTH_METHODS](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Variables/ALL_AUTH_METHODS.md)
- [AUTH_METHODS](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Variables/AUTH_METHODS.md)
- [OAUTH_METHODS](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Variables/OAUTH_METHODS.md)
- [borderRadius](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Variables/borderRadius.md)
- [borderRadiusComponents](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Variables/borderRadiusComponents.md)
- [borderRadiusSemantic](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Variables/borderRadiusSemantic.md)
- [colors](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Variables/colors.md)
- [colorsBase](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Variables/colorsBase.md)
- [colorsComponents](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Variables/colorsComponents.md)
- [colorsSemantic](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Variables/colorsSemantic.md)
- [cssVariables](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Variables/cssVariables.md)
- [font](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Variables/font.md)
- [fontComponents](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Variables/fontComponents.md)
- [fontSemantic](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Variables/fontSemantic.md)
- [theme](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Variables/theme.md)
- [tokens](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/Variables/tokens.md)
- [Overview](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/index.md)
- [Reference](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-react/reference.md)
- [CdpSolanaWallet](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-solana-standard-wallet/Classes/CdpSolanaWallet.md)
- [CdpWalletAccount](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-solana-standard-wallet/Classes/CdpWalletAccount.md)
- [useCdpSolanaStandardWallet](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-solana-standard-wallet/Functions/useCdpSolanaStandardWallet.md)
- [useSolanaStandardWallets](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-solana-standard-wallet/Functions/useSolanaStandardWallets.md)
- [CdpFeature](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-solana-standard-wallet/Type-Aliases/CdpFeature.md)
- [CdpSolanaChain](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-solana-standard-wallet/Type-Aliases/CdpSolanaChain.md)
- [CDP_SOLANA_CHAINS](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-solana-standard-wallet/Variables/CDP_SOLANA_CHAINS.md)
- [CDP_SOLANA_WALLET_STANDARD_VERSION](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-solana-standard-wallet/Variables/CDP_SOLANA_WALLET_STANDARD_VERSION.md)
- [CDP_STANDARD_SOLANA_WALLET_FEATURES](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-solana-standard-wallet/Variables/CDP_STANDARD_SOLANA_WALLET_FEATURES.md)
- [Overview](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-solana-standard-wallet/index.md)
- [Reference](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-solana-standard-wallet/reference.md)
- [createCDPEmbeddedWalletConnector](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-wagmi/Functions/createCDPEmbeddedWalletConnector.md)
- [CDP_CONNECTOR_ID](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-wagmi/Variables/CDP_CONNECTOR_ID.md)
- [Overview](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-wagmi/index.md)
- [Reference](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/cdp-wagmi/reference.md)
- [@coinbase/create-cdp-app](https://docs.cdp.coinbase.com/sdks/cdp-sdks-v2/frontend/@coinbase/create-cdp-app/index.md)
...
- [Migration Guide (v1 → v2)](https://docs.cdp.coinbase.com/x402/migration-guide.md)
- [Building Miniapps with x402](https://docs.cdp.coinbase.com/x402/miniapps.md)
- [Network Support](https://docs.cdp.coinbase.com/x402/network-support.md)
