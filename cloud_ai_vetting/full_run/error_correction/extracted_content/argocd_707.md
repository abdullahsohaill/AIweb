...
**Page Title:** Argo CD - Declarative GitOps CD for Kubernetes
--------------------
...
Follow our getting started guide . Further user oriented documentation is provided for additional features. If you are looking to upgrade Argo CD, see the upgrade guide .
Developer oriented documentation is available for people interested in building third-party integrations.
[LINK: documentation](developer-guide/)
...
[LINK: here](https://github.com/argoproj/argo-cd/releases)

## Adoption ¶

Organizations who have officially adopted Argo CD can be found here .
[LINK: here](https://github.com/argoproj/argo-cd/blob/master/USERS.md)
