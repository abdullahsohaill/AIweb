...
**Page Title:** Bases syntax - Obsidian Help
--------------------
...
- Note properties are properties defined in the note’s frontmatter. For example note.price or note["price"] . If no prefix is specified, the property is assumed to be a note property.
- File properties describe the file itself. For example file.size or file.ext . You can also reference the file object directly, e.g., file.hasLink() .
- Formula properties are other formulas in the base. Example formula.formatted_price .
