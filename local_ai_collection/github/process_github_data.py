...
# Matches the output from local_ai_collection/github/github_search_and_extract.py
RAW_INPUT_FILE = INPUT_DIR / "local_ai_github_links.csv"
PROCESSED_OUTPUT_FILE = INPUT_DIR / "local_ai_github_processed_links.csv"
...
if __name__ == "__main__":
    ...
    print("--- Starting GitHub Data Processing (Local AI) ---")
