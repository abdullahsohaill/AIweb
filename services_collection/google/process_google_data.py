# process_google_data.py
"""
This script processes the raw data from the Google Search crawler.
It prepares the data for final aggregation by:
1.  Loading the raw extracted links from the Google crawl.
...
Usage:
  - Ensure 'google_extracted_links.csv' exists.
  - Run the script: python process_google_data.py
"""
...
# --- CONFIGURATION ---
RAW_INPUT_FILE = Path("google_extracted_links.csv")
PROCESSED_OUTPUT_FILE = Path("google_processed_links.csv")
...
if __name__ == "__main__":
    ...
    print("--- Starting Google Search Data Processing (No Blocklisting) ---")
