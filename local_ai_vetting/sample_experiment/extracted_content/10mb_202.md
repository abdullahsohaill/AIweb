...
**Page Title:** UX best practices for on demand delivery  |  Other Play guides  |  Android Developers
--------------------

- English
[LINK: English](https://developer.android.com/guide/playcore/feature-delivery/ux-guidelines)
- Deutsch
[LINK: Deutsch](https://developer.android.com/guide/playcore/feature-delivery/ux-guidelines?hl=de)
- Español – América Latina
[LINK: Español – América Latina](https://developer.android.com/guide/playcore/feature-delivery/ux-guidelines?hl=es-419)
- Français
[LINK: Français](https://developer.android.com/guide/playcore/feature-delivery/ux-guidelines?hl=fr)
- Indonesia
[LINK: Indonesia](https://developer.android.com/guide/playcore/feature-delivery/ux-guidelines?hl=id)
- Italiano
[LINK: Italiano](https://developer.android.com/guide/playcore/feature-delivery/ux-guidelines?hl=it)
- Polski
[LINK: Polski](https://developer.android.com/guide/playcore/feature-delivery/ux-guidelines?hl=pl)
- Português – Brasil
[LINK: Português – Brasil](https://developer.android.com/guide/playcore/feature-delivery/ux-guidelines?hl=pt-br)
- Tiếng Việt
[LINK: Tiếng Việt](https://developer.android.com/guide/playcore/feature-delivery/ux-guidelines?hl=vi)
- Türkçe
[LINK: Türkçe](https://developer.android.com/guide/playcore/feature-delivery/ux-guidelines?hl=tr)
- Русский
[LINK: Русский](https://developer.android.com/guide/playcore/feature-delivery/ux-guidelines?hl=ru)
- עברית
[LINK: עברית](https://developer.android.com/guide/playcore/feature-delivery/ux-guidelines?hl=he)
- العربيّة
[LINK: العربيّة](https://developer.android.com/guide/playcore/feature-delivery/ux-guidelines?hl=ar)
- فارسی
[LINK: فارسی](https://developer.android.com/guide/playcore/feature-delivery/ux-guidelines?hl=fa)
- हिंदी
[LINK: हिंदी](https://developer.android.com/guide/playcore/feature-delivery/ux-guidelines?hl=hi)
- বাংলা
[LINK: বাংলা](https://developer.android.com/guide/playcore/feature-delivery/ux-guidelines?hl=bn)
- ภาษาไทย
[LINK: ภาษาไทย](https://developer.android.com/guide/playcore/feature-delivery/ux-guidelines?hl=th)
- 中文 – 简体
[LINK: 中文 – 简体](https://developer.android.com/guide/playcore/feature-delivery/ux-guidelines?hl=zh-cn)
- 中文 – 繁體
[LINK: 中文 – 繁體](https://developer.android.com/guide/playcore/feature-delivery/ux-guidelines?hl=zh-tw)
- 日本語
[LINK: 日本語](https://developer.android.com/guide/playcore/feature-delivery/ux-guidelines?hl=ja)
- 한국어
[LINK: 한국어](https://developer.android.com/guide/playcore/feature-delivery/ux-guidelines?hl=ko)
[LINK: Android Studio](https://developer.android.com/studio)
[LINK: Sign in](https://developer.android.com/_d/signin?continue=https%3A%2F%2Fdeveloper.android.com%2Fguide%2Fplaycore%2Ffeature-delivery%2Fux-guidelines&prompt=select_account)
- Google Play
[LINK: Google Play](https://developer.android.com/distribute)
- Other Play guides
[LINK: Other Play guides](https://developer.android.com/guide/app-bundle)
- On this page
...
## UX best practices for on demand delivery Stay organized with collections Save and categorize content based on your preferences.
...
- Editing and uploading a video in an app where the majority of users only
watch videos
- Adding a recipe in an app, where most users only browse and follow others'
recipes
- Help and support functionality when most users don't seek help, or don't
seek it within the app
- Large libraries for less used functionality such as providing detailed bug
...
- Ensure your users are aware and feel in control of relatively larger module
downloads which don't load instantly, or module install errors.
- Further optimize the module delivery experience, especially in situations
where you can anticipate that a user will need a particular module.
After you’ve read through this guide, see these best practices in action by
trying the Play Core API sample app .
[LINK: Play Core API sample app](https://github.com/android/app-bundle-samples/tree/main/DynamicFeatures)
...
the download.
You can monitor the request state to display the download progress and install state. However, the type of UI you
want to display might depend on the size of the download:
- For smaller modules (~10 MB or less) that can be installed very quickly,
consider indicators such as spinners or a brief “downloading content”
message.
- For larger modules that can take a few seconds or longer to download and
install, consider showing a download and install progress bar, such as the
...
they can do, as shown in figures 2 and 3. For example, if you monitor the state of the download request ,
...
the size of your app on a user’s device by requesting Google Play to uninstall that module .
...
want to add support for conditional delivery to include your feature at install time based on user country, device hardware
