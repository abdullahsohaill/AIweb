...
[LINK: All examples](/docs/examples)
[LINK: Transcribe speech in batches with Whisper Turn audio bytes into text at scale](/docs/examples/batched_whisper)

### Transcribe speech in batches with Whisper

Turn audio bytes into text at scale
[LINK: Voice chat with LLMs Build an interactive voice chat app](/docs/examples/llm-voice-chat)

### Voice chat with LLMs

Build an interactive voice chat app
[LINK: Transcribe speech with Kyutai STT Stream transcripts at the speed of speech](/docs/examples/streaming_kyutai_stt)

### Transcribe speech with Kyutai STT

Stream transcripts at the speed of speech
[LINK: Make music Turn prompts into music with ACE-Step](/docs/examples/generate_music)

### Make music

Turn prompts into music with ACE-Step
[LINK: Fast podcast transcriptions Build an end-to-end podcast transcription app that leverages dozens of containers for super-fast processing](/docs/examples/whisper-transcriber)
...
[LINK: Fine-tune Whisper on domain vocab Improve Whisper transcription accuracy on specialized vocabularies with fine-tuning](/docs/examples/fine_tune_asr)

### Fine-tune Whisper on domain vocab

Improve Whisper transcription accuracy on specialized vocabularies with fine-tuning
[LINK: Deploy a TTS API with Chatterbox Serve text-to-speech with Chatterbox to generate natural audio from text](/docs/examples/chatterbox_tts)
...
[LINK: Learn More](/docs/guide/security)
[LINK: Learn More](/docs/guide/security)
...
Bullish on @modal - Great Docs + Examples
...
@modal has got a bunch of stuff just worked out
...
I've realized @modal is actually a great fit for ML training pipelines.
...
Late to the party, but finally playing with @modal to run some backend jobs.
...
[LINK: Serve your own LLM API](/docs/examples/llm_inference)
Create custom art of your pet
[LINK: Create custom art of your pet](/docs/examples/diffusers_lora_finetune)
Analyze Parquet files from S3 with DuckDB
[LINK: Analyze Parquet files from S3 with DuckDB](/docs/examples/s3_bucket_mount)
Run hundreds of LoRAs from one app
[LINK: Run hundreds of LoRAs from one app](/docs/examples/cloud_bucket_mount_loras)
Finetune an LLM to replace your CEO
[LINK: Finetune an LLM to replace your CEO](/docs/examples/llm-finetuning)
Company
About
Blog
Careers
...
Privacy Policy
Security & Privacy
[LINK: Security & Privacy](/docs/guide/security)
Terms
© Modal 2026
