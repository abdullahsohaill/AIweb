...
**Page Title:** Build WebGPU Apps Today with PlayCanvas | PlayCanvas Blog
--------------------
...
[LINK: Engine v1.70.0](https://github.com/playcanvas/engine/releases/tag/v1.70.0)
Click here to run it for yourself in a WebGPU-enabled browser (i.e. Chrome or Edge).
[LINK: Click here](https://playcanvas.github.io/#/compute/particles)
...
[LINK: submit an issue](https://github.com/playcanvas/editor/issues)
- WebGPU on the Rise
- Why WebGPU Matters
- Getting Started with WebGPU
- Your Feedback is Important
