# Jan
**URL:** https://www.jan.ai/docs/desktop/api-server
**Page Title:** Local API Server
--------------------
...
- Enter a custom API Key (e.g., secret-key-123 ). This is required for all requests.
- Click Start Server .
...
- 404 Not Found: The model ID in your request body does not match an available model in Jan. Your request URL is incorrect (check the API Prefix).
...
[LINK: Model Context Protocol](/docs/desktop/mcp)
[LINK: LlamaCpp Server](/docs/desktop/llama-cpp-server)
